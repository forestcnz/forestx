...
async def _handle_connection(
    ...
    *,
    ...
    # Request 1: provoke a function call (mirrors `forestx-rs/core/tests/suite/agent_websocket.rs`).
...
start forestx with `forestx --profile localapi_ws`
""")
    sys.stdout.flush()
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Mock a minimal Responses API WebSocket endpoint for the `test_forestx` flow.\n"
