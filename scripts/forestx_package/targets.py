...
PACKAGE_VARIANTS: dict[str, PackageVariant] = {
    "forestx": PackageVariant(
        name="forestx",
        cargo_bin="forestx",
        executable_stem="forestx",
    ),
    "forestx-app-server": PackageVariant(
        name="forestx-app-server",
        cargo_bin="forestx-app-server",
        executable_stem="forestx-app-server",
    ),
}
