---
name: test-tui
description: Guide for testing Forestx TUI interactively
---

You can start and use Forestx TUI to verify changes. 
...
Use `just forestx` target to run - `just forestx -c ...`
