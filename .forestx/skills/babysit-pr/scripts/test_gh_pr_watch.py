...
def sample_pr():
    return {
        "number": 123,
        "url": "https://github.com/openai/forestx/pull/123",
        "repo": "openai/forestx",
        "head_sha": "abc123",
        "head_branch": "feature",
        "state": "OPEN",
...
def test_pending_review_feedback_surfaces_only_after_publication(monkeypatch):
    ...
    review = {
        ...
        "submitted_at": None,
        "html_url": "https://github.com/openai/forestx/pull/123#pullrequestreview-10",
    }
    review_comment = {
        "id": 20,
        ...
        "path": "src/example.rs",
        "line": 7,
        "html_url": "https://github.com/openai/forestx/pull/123#discussion_r20",
    }
...
def test_run_watch_keeps_polling_open_ready_to_merge_pr(monkeypatch):
    ...
    monkeypatch.setattr(
        gh_pr_watch,
        "collect_snapshot",
        lambda args: (snapshot, Path("/tmp/forestx-babysit-pr-state.json")),
    )
    monkeypatch.setattr(
        gh_pr_watch,
        "print_event",
        ...
        99: [
            {
                ...
                "status": "completed",
                "conclusion": "failure",
                "html_url": "https://github.com/openai/forestx/actions/runs/99/job/555",
            },
            {
                "id": 556,
                "name": "lint",
    ...
    assert failed_jobs == [
        {
            ...
            "conclusion": "failure",
            "html_url": "https://github.com/openai/forestx/actions/runs/99/job/555",
            "logs_endpoint": "repos/openai/forestx/actions/jobs/555/logs",
        }
    ]
