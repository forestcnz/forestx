---
name: path-types
description: Choose Rust types for operating system paths across the Forestx repository. Use when defining new path-bearing types or explicitly migrating existing ones.
---
