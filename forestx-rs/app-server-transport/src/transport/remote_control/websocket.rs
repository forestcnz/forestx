...
pub(super) const REMOTE_CONTROL_INSTALLATION_ID_HEADER: &str = "x-forestx-installation-id";
const REMOTE_CONTROL_SUBSCRIBE_CURSOR_HEADER: &str = "x-forestx-subscribe-cursor";
...
fn build_remote_control_websocket_request(
    ...
    set_remote_control_header(headers, "x-forestx-server-id", &enrollment.server_id)?;
...
mod tests {
    ...
    pub(super) async fn remote_control_state_runtime(forestx_home: &TempDir) -> Arc<StateRuntime> {
        StateRuntime::init(
