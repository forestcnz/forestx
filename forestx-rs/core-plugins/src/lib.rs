...
pub type LoadedPlugin = forestx_plugin::LoadedPlugin<forestx_config::McpServerConfig>;
pub type PluginLoadOutcome = forestx_plugin::PluginLoadOutcome<forestx_config::McpServerConfig>;
