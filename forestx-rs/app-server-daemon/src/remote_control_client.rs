...
use forestx_app_server_protocol::RemoteControlDisableParams;
use forestx_app_server_protocol::RemoteControlDisableResponse;
use forestx_app_server_protocol::RemoteControlEnableParams;
...
async fn connect_with_retry(
    ...
    connect_timeout: Duration,
    connect_retry_delay: Duration,
) -> Result<WebSocketStream<forestx_uds::UnixStream>> {
...
mod tests {
    ...
    const TEST_FORESTX_HOME: &str = "/tmp/forestx-home";
        ...
        client::send_message(
            ...
            &JSONRPCMessage::Response(JSONRPCResponse {
                ...
                result: serde_json::json!({
                    "userAgent": "forestx_app_server/1.2.3",
                    "forestxHome": TEST_FORESTX_HOME,
                    "platformFamily": "unix",
                    "platformOs": "macos",
                }),
            }),
