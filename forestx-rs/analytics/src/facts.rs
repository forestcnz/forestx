...
pub use forestx_protocol::error::ForestxErrKind;
...
/// Measurements for one successfully decoded image at the point where Forestx prepares it for
...
#[derive(Clone)]
pub struct TurnForestxErrorFact {
    pub(crate) turn_id: String,
    pub(crate) thread_id: String,
    pub(crate) error: TurnForestxError,
}

impl TurnForestxErrorFact {
    pub fn from_forestx_err(thread_id: String, turn_id: String, error: &ForestxErr) -> Self {
        Self {
            turn_id,
            thread_id,
            error: TurnForestxError::from_forestx_err(error),
        }
    }
}

#[derive(Clone)]
pub(crate) struct TurnForestxError {
    pub(crate) kind: ForestxErrKind,
    pub(crate) http_status_code: Option<u16>,
}

impl TurnForestxError {
    fn from_forestx_err(error: &ForestxErr) -> Self {
        Self {
            kind: error.into(),
...
#[derive(Clone)]
pub struct ForestxTurnSteerEvent {
...
#[derive(Clone)]
pub struct ForestxCompactionEvent {
    pub thread_id: String,
    pub turn_id: String,
    ...
    pub forestx_error_kind: Option<ForestxErrKind>,
    pub forestx_error_http_status_code: Option<u16>,
...
#[derive(Clone)]
pub struct ForestxGoalEvent {
    pub thread_id: String,
    pub turn_id: Option<String>,
    pub goal_id: String,
    pub event_kind: GoalEventKind,
    pub goal_status: forestx_state::ThreadGoalStatus,
...
pub(crate) enum CustomAnalyticsFact {
    ...
    Compaction(Box<ForestxCompactionEvent>),
    Goal(Box<ForestxGoalEvent>),
    GuardianReview(Box<GuardianReviewEventParams>),
    TurnResolvedConfig(Box<TurnResolvedConfigFact>),
    TurnTokenUsage(Box<TurnTokenUsageFact>),
    TurnProfile(Box<TurnProfileFact>),
    TurnForestxError(Box<TurnForestxErrorFact>),
