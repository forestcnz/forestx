...
use forestx_analytics::ForestxGoalEvent;
use forestx_analytics::GoalEventKind;
...
impl GoalAnalytics {
    ...
    pub(crate) fn cleared(&self, goal: &forestx_state::ThreadGoal) {
    ...
    fn track(
        ...
        self.client.track_goal_event(ForestxGoalEvent {
