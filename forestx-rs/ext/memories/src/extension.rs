...
/// Contributes Forestx memory read-path prompt context and memory read tools.
...
pub(crate) struct MemoriesExtensionConfig {
    ...
    pub(crate) forestx_home: AbsolutePathBuf,
}
...
impl ContextContributor for MemoriesExtension {
    fn contribute_thread_context<'a>(
        ...
        Box::pin(async move {
            ...
            build_memory_tool_developer_instructions(&config.forestx_home)
                .await
...
impl ToolContributor for MemoriesExtension {
    fn tools(
        ...
        tools::memory_tools(
            LocalMemoriesBackend::from_forestx_home(&config.forestx_home),
