...
use forestx_config::SkillsConfig;
...
use forestx_core_skills::config_rules::SkillConfigRules;
...
use forestx_skills::install_system_skills;
...
impl HostSkillsService {
    pub fn new(forestx_home: AbsolutePathBuf, bundled_skills_enabled: bool) -> Self {
        Self::new_with_restriction_product(forestx_home, bundled_skills_enabled, Some(Product::Forestx))
    }
    ...
    pub fn new_with_restriction_product(
        ...
        // The cache is shared by every process using this FORESTX_HOME. Disabled services filter
    ...
    async fn build_skill_outcome(
        ...
        .await;
        let outcome = forestx_core_skills::filter_skill_load_outcome_for_product(
            outcome,
    ...
    fn ensure_system_skills_installed(&self) {
        if let Err(err) = install_system_skills(&self.forestx_home) {
