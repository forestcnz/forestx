...
use forestx_config::default_project_root_markers;
use forestx_config::merge_toml_values;
use forestx_config::project_root_markers_from_config;
    ...
    for layer in config_layer_stack.all_layers_high_to_low() {
        ...
        match &layer.name {
            ...
            ConfigLayerSource::User { .. } => {
                // Deprecated user skills location (`$FORESTX_HOME/skills`), kept for backward
                // compatibility.
