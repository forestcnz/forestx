...
const RUN_METRIC: &str = "forestx.skills.shadow_selection";
const DURATION_METRIC: &str = "forestx.skills.shadow_selection.duration_ms";
const CATALOG_ENTRY_COUNT_METRIC: &str = "forestx.skills.shadow_selection.catalog_entries";
const SELECTED_ENTRY_COUNT_METRIC: &str = "forestx.skills.shadow_selection.selected_entries";
const QUERY_TERM_COUNT_METRIC: &str = "forestx.skills.shadow_selection.query_terms";
const REDUCTION_BPS_METRIC: &str = "forestx.skills.shadow_selection.reduction_bps";
const INVOCATION_METRIC: &str = "forestx.skills.shadow_selection.invocation";
