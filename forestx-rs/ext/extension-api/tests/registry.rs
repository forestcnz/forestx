...
use forestx_extension_api::ApprovalReviewContributor;
        ...
        fragments.extend(
            contributor
                .contribute_turn_context(TurnContextContributionInput {
                    thread_id: forestx_protocol::ThreadId::default(),
