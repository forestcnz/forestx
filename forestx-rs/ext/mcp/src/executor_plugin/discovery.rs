...
use forestx_core_plugins::manifest::parse_plugin_manifest_uri;
use forestx_exec_server::CapabilityRootDiscovery;
use forestx_mcp::parse_executor_plugin_mcp_config;
...
fn parse_mcp_servers(
    selected_root: &SelectedCapabilityRoot,
    plugin_root: &forestx_utils_path_uri::PathUri,
    contents: &str,
    environment_id: &str,
) -> Vec<(String, forestx_config::McpServerConfig)> {
