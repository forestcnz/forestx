use forestx_connectors_extension::ExecutorPluginConnectorProvider;
use forestx_core::config::Config;
use forestx_core_plugins::ExecutorPluginProvider;
...
struct SelectedPluginMetadata {
    ...
    servers: Vec<(String, forestx_config::McpServerConfig)>,
