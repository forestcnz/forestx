...
fn file_link_hides_destination() {
    let text = render_markdown_text_for_cwd(
        "[forestx-rs/tui/src/markdown_render.rs](/Users/example/code/forestx/forestx-rs/tui/src/markdown_render.rs)",
        Path::new("/Users/example/code/forestx"),
    );
    let expected =
        Text::from(Line::from_iter(["forestx-rs/tui/src/markdown_render.rs".cyan()]));
    assert_eq!(text, expected);
}
...
fn file_link_decodes_percent_encoded_bare_path_destination() {
    let text = render_markdown_text_for_cwd(
        "[report](/Users/example/code/forestx/Example%20Folder/R%C3%A9sum%C3%A9/report.md)",
        Path::new("/Users/example/code/forestx"),
    );
    let expected = Text::from(Line::from_iter([
...
fn file_link_appends_line_number_when_label_lacks_it() {
    let text = render_markdown_text_for_cwd(
        "[markdown_render.rs](/Users/example/code/forestx/forestx-rs/tui/src/markdown_render.rs:74)",
        Path::new("/Users/example/code/forestx"),
    );
    let expected = Text::from(Line::from_iter([
        "forestx-rs/tui/src/markdown_render.rs:74".cyan(),
    ]));
    assert_eq!(text, expected);
}
...
fn file_link_keeps_absolute_paths_outside_cwd() {
    let text = render_markdown_text_for_cwd(
        "[README.md:74](/Users/example/code/forestx/README.md:74)",
        Path::new("/Users/example/code/forestx/forestx-rs/tui"),
    );
    let expected = Text::from(Line::from_iter(["/Users/example/code/forestx/README.md:74".cyan()]));
    assert_eq!(text, expected);
}
...
fn file_link_appends_hash_anchor_when_label_lacks_it() {
    let text = render_markdown_text_for_cwd(
        "[markdown_render.rs](file:///Users/example/code/forestx/forestx-rs/tui/src/markdown_render.rs#L74C3)",
        Path::new("/Users/example/code/forestx"),
    );
    let expected =
        Text::from(Line::from_iter([
            "forestx-rs/tui/src/markdown_render.rs:74:3".cyan(),
        ]));
    assert_eq!(text, expected);
}
...
fn file_link_uses_target_path_for_hash_anchor() {
    let text = render_markdown_text_for_cwd(
        "[markdown_render.rs#L74C3](file:///Users/example/code/forestx/forestx-rs/tui/src/markdown_render.rs#L74C3)",
        Path::new("/Users/example/code/forestx"),
    );
    let expected =
        Text::from(Line::from_iter([
...
fn file_link_appends_range_when_label_lacks_it() {
    let text = render_markdown_text_for_cwd(
        "[markdown_render.rs](/Users/example/code/forestx/forestx-rs/tui/src/markdown_render.rs:74:3-76:9)",
        Path::new("/Users/example/code/forestx"),
    );
    let expected =
        Text::from(Line::from_iter([
            "forestx-rs/tui/src/markdown_render.rs:74:3-76:9".cyan(),
        ]));
    assert_eq!(text, expected);
}
...
fn file_link_uses_target_path_for_range() {
    let text = render_markdown_text_for_cwd(
        "[markdown_render.rs:74:3-76:9](/Users/example/code/forestx/forestx-rs/tui/src/markdown_render.rs:74:3-76:9)",
        Path::new("/Users/example/code/forestx"),
    );
    let expected =
        Text::from(Line::from_iter([
...
fn file_link_appends_hash_range_when_label_lacks_it() {
    let text = render_markdown_text_for_cwd(
        "[markdown_render.rs](file:///Users/example/code/forestx/forestx-rs/tui/src/markdown_render.rs#L74C3-L76C9)",
        Path::new("/Users/example/code/forestx"),
    );
    let expected =
        Text::from(Line::from_iter([
...
fn multiline_file_link_label_after_styled_prefix_does_not_panic() {
    let text = render_markdown_text_for_cwd(
        "**bold** plain [foo\nbar](file:///Users/example/code/forestx/forestx-rs/tui/src/markdown_render.rs#L74C3)",
        Path::new("/Users/example/code/forestx"),
    );
    let expected = Text::from(Line::from_iter([
        "bold".bold(),
...
fn file_link_uses_target_path_for_hash_range() {
    let text = render_markdown_text_for_cwd(
        "[markdown_render.rs#L74C3-L76C9](file:///Users/example/code/forestx/forestx-rs/tui/src/markdown_render.rs#L74C3-L76C9)",
        Path::new("/Users/example/code/forestx"),
    );
    let expected =
        Text::from(Line::from_iter([
...
fn markdown_render_file_link_snapshot() {
    let text = render_markdown_text_for_cwd(
        "See [markdown_render.rs:74](/Users/example/code/forestx/forestx-rs/tui/src/markdown_render.rs:74).",
        Path::new("/Users/example/code/forestx"),
    );
    let rendered = text
        .lines
...
fn unordered_list_local_file_link_stays_inline_with_following_text() {
    let text = render_markdown_text_with_width_and_cwd(
        "- [binary](/Users/example/code/forestx/forestx-rs/README.md:93): core is the agent/business logic, tui is the terminal UI, exec is the headless automation surface, and cli is the top-level multitool binary.",
        Some(72),
        Some(Path::new("/Users/example/code/forestx")),
    );
    let rendered = text
        .lines
        .iter()
    ...
    assert_eq!(
        rendered,
        vec![
            "- forestx-rs/README.md:93: core is the agent/business logic, tui is the",
...
fn unordered_list_local_file_link_soft_break_before_colon_stays_inline() {
    let text = render_markdown_text_with_width_and_cwd(
        "- [binary](/Users/example/code/forestx/forestx-rs/README.md:93)\n  : core is the agent/business logic.",
        Some(72),
        Some(Path::new("/Users/example/code/forestx")),
    );
    let rendered = text
    ...
    assert_eq!(
        rendered,
        vec!["- forestx-rs/README.md:93: core is the agent/business logic.",]
    );
}
...
fn consecutive_unordered_list_local_file_links_do_not_detach_paths() {
    let text = render_markdown_text_with_width_and_cwd(
        "- [binary](/Users/example/code/forestx/forestx-rs/README.md:93)\n  : cli is the top-level multitool binary.\n- [expectations](/Users/example/code/forestx/forestx-rs/core/README.md:1)\n  : forestx-core owns the real runtime behavior.",
        Some(72),
        Some(Path::new("/Users/example/code/forestx")),
    );
    let rendered = text
    ...
    assert_eq!(
        rendered,
        vec![
            "- forestx-rs/README.md:93: cli is the top-level multitool binary.",
            "- forestx-rs/core/README.md:1: forestx-core owns the real runtime behavior.",
        ]
    );
}
...
|---|---:|---:|---:|---|
| Suggestion engine and unit coverage | [next_prompt_suggestion.rs](/Users/example/code/forestx/forestx-rs/core/src/next_prompt_suggestion.rs:1), [next_prompt_suggestion_tests.rs](/Users/example/code/forestx/forestx-rs/core/src/next_prompt_suggestion_tests.rs:1) | 704 | 0 | Sampling workflow, stable-history checks, tool-flow suppression, fast reasoning profile, filtering rules, cancellation and timeout. |
| Model instruction fragment and contextual isolation | [next_prompt_suggestion.rs](/Users/example/code/forestx/forestx-rs/core/src/context/next_prompt_suggestion.rs:1), [contextual_user_message_tests.rs](/Users/example/code/forestx/forestx-rs/core/src/context/contextual_user_message_tests.rs:1) | 54 | 0 | Synthetic suggestion prompt and an isolation test for ordinary user text. |
"#;
    let text = render_markdown_text_with_width_and_cwd(
        md,
        Some(/*width*/ 120),
...
| --- | --- | --- |
| [2026-05-25 current gallery](/Users/felipe.coury/.forestx/sessions/2026/05/25/rollout-2026-05-25T18-13-09-019e60fc-0518-7c21-9596-980fe97225ba.jsonl) | The large gallery from this thread: emojis, links, emphasis, code, alignment, paragraphs, and a 30+ row table | 7 |
| [2026-05-14 renderer testing](/Users/felipe.coury/.forestx/sessions/2026/05/14/rollout-2026-05-14T12-57-18-019e2734-e500-7011-8278-975c94d06000.jsonl) | Explicit "markdown tables for testing" session with several successive assistant samples | 16 |
| [2026-05-14 five-table test](/Users/felipe.coury/.forestx/sessions/2026/05/14/rollout-2026-05-14T12-27-57-019e271a-064c-78c3-a5cd-a6f20a0c1ad5.jsonl) | Explicit request for five tables containing emojis, code, italics, and varied cell content | 10 |
"#;
...
| --- | ---: | ---: | --- |
| [#24485: newline shortcut fails in PyCharm terminal on Windows](https://github.com/openai/forestx/issues/24485) | `+1` 0, substantive comments 0 | Low | New, deterministic regression range; localized composer/keymap path. |
| [#23926: Vim composer `e` stalls at word end](https://github.com/openai/forestx/issues/23926) | `+1` 0, comments 0 | Low | Standing best quick win; deterministic motion bug. |
| [#23651: Zellij scrollback misses Forestx transcript over SSH](https://github.com/openai/forestx/issues/23651) | `+1` 3, human comments 2 | Medium | Clear regression and strong scrollback evidence. |
| [#23740: raw ANSI/control sequences in Windows Terminal](https://github.com/openai/forestx/issues/23740) | `+1` 7, human comments 7 | Medium | Highest activity; established Windows rendering regression family. |
| [#24527: typing lag increases with session length](https://github.com/openai/forestx/issues/24527) | `+1` 0, substantive comments 0 | Medium | New TUI-visible performance report; needs profiling before implementation. |
"#;
