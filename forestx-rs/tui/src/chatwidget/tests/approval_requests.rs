...
fn app_server_exec_approval_request_preserves_permissions_context() {
    ...
    let request = exec_approval_request_from_params(
        AppServerCommandExecutionRequestApprovalParams {
            ...
            environment_id: None,
            reason: None,
            network_approval_context: Some(forestx_app_server_protocol::NetworkApprovalContext {
                host: "example.com".to_string(),
                protocol: forestx_app_server_protocol::NetworkApprovalProtocol::Socks5Tcp,
            }),
    ...
    assert_eq!(
        ...
        Some(forestx_app_server_protocol::NetworkApprovalContext {
            host: "example.com".to_string(),
            protocol: forestx_app_server_protocol::NetworkApprovalProtocol::Socks5Tcp,
        })
    );
...
async fn network_exec_approval_history_describes_session_host_allowance() {
    ...
    let request = exec_approval_request_from_params(
        AppServerCommandExecutionRequestApprovalParams {
            ...
            network_approval_context: Some(forestx_app_server_protocol::NetworkApprovalContext {
                host: "example.com".to_string(),
                protocol: forestx_app_server_protocol::NetworkApprovalProtocol::Https,
            }),
...
async fn network_exec_approval_history_describes_one_time_host_allowance() {
    ...
    let request = exec_approval_request_from_params(
        AppServerCommandExecutionRequestApprovalParams {
            ...
            network_approval_context: Some(forestx_app_server_protocol::NetworkApprovalContext {
                host: "example.com".to_string(),
                protocol: forestx_app_server_protocol::NetworkApprovalProtocol::Http,
            }),
            command: None,
            cwd: None,
            command_actions: None,
