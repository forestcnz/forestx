...
impl ChatWidget {
        ...
        match cmd {
            ...
            SlashCommand::Archive => {
                self.bottom_pane.show_selection_view(SelectionViewParams {
                    ...
                    subtitle: Some(
                        "Are you sure? This will archive the current session and exit Forestx"
                            .to_string(),
                    ),
            ...
            SlashCommand::Rename => {
                self.session_telemetry
                    .counter("forestx.thread.rename", /*inc*/ 1, &[]);
            ...
            SlashCommand::ElevateSandbox => {
                #[cfg(target_os = "windows")]
                {
                    ...
                    self.session_telemetry.counter(
                        "forestx.windows_sandbox.setup_elevated_sandbox_command",
                        /*inc*/ 1,
                        &[],
                    );
                    self.app_event_tx
    ...
    fn builtin_command_flags(&self) -> BuiltinCommandFlags {
        ...
        BuiltinCommandFlags {
            ...
            token_activity_command_enabled: self.has_forestx_backend_auth,
    ...
    fn ensure_usage_command_available(&mut self) -> bool {
        if self.has_forestx_backend_auth {
            return true;
        }
