...
impl ChatWidget {
    ...
    pub(super) fn on_guardian_review_notification(
        ...
        turn_id: String,
        started_at_ms: i64,
        review: forestx_app_server_protocol::GuardianApprovalReview,
        completion: Option<(i64, forestx_app_server_protocol::AutoReviewDecisionSource)>,
        ...
        self.on_guardian_assessment(GuardianAssessmentEvent {
            ...
            status: match review.status {
                forestx_app_server_protocol::GuardianApprovalReviewStatus::InProgress => {
                    GuardianAssessmentStatus::InProgress
                }
                forestx_app_server_protocol::GuardianApprovalReviewStatus::Approved => {
                    GuardianAssessmentStatus::Approved
                }
                forestx_app_server_protocol::GuardianApprovalReviewStatus::Denied => {
                    GuardianAssessmentStatus::Denied
                }
                forestx_app_server_protocol::GuardianApprovalReviewStatus::TimedOut => {
                    GuardianAssessmentStatus::TimedOut
                }
                forestx_app_server_protocol::GuardianApprovalReviewStatus::Aborted => {
                    GuardianAssessmentStatus::Aborted
                }
            },
            risk_level: review.risk_level.map(|risk_level| match risk_level {
                forestx_app_server_protocol::GuardianRiskLevel::Low => {
                    forestx_protocol::approvals::GuardianRiskLevel::Low
                }
                forestx_app_server_protocol::GuardianRiskLevel::Medium => {
                    forestx_protocol::approvals::GuardianRiskLevel::Medium
                }
                forestx_app_server_protocol::GuardianRiskLevel::High => {
                    forestx_protocol::approvals::GuardianRiskLevel::High
                }
                forestx_app_server_protocol::GuardianRiskLevel::Critical => {
                    forestx_protocol::approvals::GuardianRiskLevel::Critical
                }
            }),
            user_authorization: review.user_authorization.map(|user_authorization| {
                match user_authorization {
                    forestx_app_server_protocol::GuardianUserAuthorization::Unknown => {
                        forestx_protocol::approvals::GuardianUserAuthorization::Unknown
                    }
                    forestx_app_server_protocol::GuardianUserAuthorization::Low => {
                        forestx_protocol::approvals::GuardianUserAuthorization::Low
                    }
                    forestx_app_server_protocol::GuardianUserAuthorization::Medium => {
                        forestx_protocol::approvals::GuardianUserAuthorization::Medium
                    }
                    forestx_app_server_protocol::GuardianUserAuthorization::High => {
                        forestx_protocol::approvals::GuardianUserAuthorization::High
                    }
                }
            }),
            rationale: review.rationale,
            decision_source: decision_source.map(|source| match source {
                forestx_app_server_protocol::AutoReviewDecisionSource::Agent => {
