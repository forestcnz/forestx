...
impl ChatWidget {
    pub(crate) fn new_with_app_event(common: ChatWidgetInit) -> Self {
        Self::new_with_op_target(common, ForestxOpTarget::AppEvent)
    }
    ...
    pub(super) fn new_with_op_target(
        ...
        let pet_http_client = forestx_http_client::RouteAwareClientPool::new(
            config.http_client_factory(),
            forestx_http_client::ClientRouteClass::Other,
        );
        ...
        let mut widget = Self {
            ...
            forestx_rate_limit_reached_type: None,
            forestx_spend_control_reached: None,
        ...
        widget
            .bottom_pane
            .set_token_activity_command_enabled(widget.has_forestx_backend_auth);
