...
impl ChatWidget {
    ...
    pub(crate) fn has_forestx_backend_auth(&self) -> bool {
    ...
    pub(crate) fn update_account_state(
        ...
        self.has_forestx_backend_auth = has_forestx_backend_auth;
        self.bottom_pane
            .set_connectors_enabled(self.connectors_enabled());
        self.bottom_pane
            .set_token_activity_command_enabled(has_forestx_backend_auth);
        self.refresh_status_surfaces();
    }
    ...
    pub(crate) fn set_collaboration_mask(&mut self, mut mask: CollaborationModeMask) {
            ...
            && (previous_model != next_model || previous_effort != next_effort)
        {
            ...
            if !next_model.starts_with("forestx-auto-") {
