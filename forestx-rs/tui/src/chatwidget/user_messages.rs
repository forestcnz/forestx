...
use forestx_app_server_protocol::TextElement as AppServerTextElement;
...
use forestx_utils_plugins::mention_syntax::PLUGIN_TEXT_MENTION_SIGIL;
use forestx_utils_plugins::mention_syntax::TOOL_MENTION_SIGIL;
        ...
        .filter_map(|item| match item {
            ...
            UserInput::Mention { name, path } => {
                ...
                let mention = if let Some(plugin_id) = plugin_id {
                    ...
                    forestx_connectors::metadata::connector_mention_slug_from_name(name)
                } else {
                    name.clone()
                };
