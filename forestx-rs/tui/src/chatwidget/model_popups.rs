...
impl ChatWidget {
    ...
    fn is_auto_model(model: &str) -> bool {
        model.starts_with("forestx-auto-")
    }

    fn auto_model_order(model: &str) -> usize {
        match model {
            "forestx-auto-fast" => 0,
            "forestx-auto-balanced" => 1,
            "forestx-auto-thorough" => 2,
            _ => 3,
        }
    }
    ...
    pub(crate) fn open_all_models_popup(&mut self, presets: Vec<ModelPreset>) {
        ...
        let header = self.model_menu_header(
            ...
            "Access legacy models by running forestx -m <model_name> or in your config.toml",
        );
        self.bottom_pane.show_selection_view(SelectionViewParams {
    ...
    pub(crate) fn open_reasoning_popup(&mut self, preset: ModelPreset) {
        ...
        let warn_for_model = preset.model.starts_with("gpt-5.1-forestx")
            || preset.model.starts_with("gpt-5.1-forestx-max")
