...
//! "leave the old title alone" or "clear the title Forestx last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Forestx manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Forestx started managing the title.
