...
//! the fallback bucket.
//!
//! These caps are deliberately conservative: Forestx is rebuilding normal terminal scrollback, not an
...
use forestx_config::types::DEFAULT_TERMINAL_RESIZE_REFLOW_FALLBACK_MAX_ROWS;
