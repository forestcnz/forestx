...
mod tests {
    ...
    fn make_selection_view(subtitle: Option<&str>) -> ListSelectionView {
        ...
        let items = vec![
            SelectionItem {
                ...
                description: Some("Forestx can read files".to_string()),
                is_current: true,
            ...
            SelectionItem {
                ...
                description: Some("Forestx can edit files".to_string()),
                is_current: false,
                dismiss_on_select: true,
                ..Default::default()
            },
    ...
    fn renders_blank_line_between_subtitle_and_items() {
        let view = make_selection_view(Some("Switch between Forestx approval presets"));
    ...
    fn width_changes_do_not_hide_rows() {
        ...
        let items = vec![
            SelectionItem {
                name: "gpt-5.1-forestx".to_string(),
                description: Some(
                    "Optimized for Forestx. Balance of reasoning quality and coding ability."
                        .to_string(),
                ),
                is_current: true,
                dismiss_on_select: true,
            ...
            SelectionItem {
                name: "gpt-5.1-forestx-mini".to_string(),
                description: Some(
                    "Optimized for Forestx. Cheaper, faster, but less capable.".to_string(),
                ),
                dismiss_on_select: true,
                ..Default::default()
            },
            SelectionItem {
                name: "gpt-4.1-forestx".to_string(),
                description: Some(
