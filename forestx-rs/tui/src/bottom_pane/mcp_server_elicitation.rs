...
use forestx_app_server_protocol::McpElicitationEnumSchema;
use forestx_app_server_protocol::McpElicitationPrimitiveSchema;
use forestx_app_server_protocol::McpElicitationSingleSelectEnumSchema;
...
use forestx_protocol::mcp_approval_meta::APPROVAL_KIND_KEY as APPROVAL_META_KIND_KEY;
use forestx_protocol::mcp_approval_meta::APPROVAL_KIND_MCP_TOOL_CALL as APPROVAL_META_KIND_MCP_TOOL_CALL;
use forestx_protocol::mcp_approval_meta::APPROVAL_KIND_TOOL_SUGGESTION as APPROVAL_META_KIND_TOOL_SUGGESTION;
use forestx_protocol::mcp_approval_meta::PERSIST_ALWAYS as APPROVAL_PERSIST_ALWAYS_VALUE;
use forestx_protocol::mcp_approval_meta::PERSIST_KEY as APPROVAL_PERSIST_KEY;
use forestx_protocol::mcp_approval_meta::PERSIST_SESSION as APPROVAL_PERSIST_SESSION_VALUE;
use forestx_protocol::mcp_approval_meta::TOOL_NAME_KEY;
use forestx_protocol::mcp_approval_meta::TOOL_PARAMS_DISPLAY_KEY as APPROVAL_TOOL_PARAMS_DISPLAY_KEY;
use forestx_protocol::mcp_approval_meta::TOOL_PARAMS_KEY as APPROVAL_TOOL_PARAMS_KEY;
    ...
    fn tool_suggestion_meta_is_parsed_into_request_payload() {
        let request = from_form_request(
            ...
            form_request(
                ...
                empty_object_schema(),
                Some(serde_json::json!({
                    "forestx_approval_kind": "tool_suggestion",
                    "tool_type": "connector",
