...
//!
//! For the detailed burst state machine, see `forestx-rs/tui/src/bottom_pane/paste_burst.rs`.
//!
...
use forestx_message_history::HistoryBatchCursor;
    ...
    fn mention_items(&self) -> Vec<MentionItem> {
            ...
            && let Some(snapshot) = self.connectors_snapshot.as_ref()
        {
            for connector in &snapshot.connectors {
                ...
                let display_name = forestx_connectors::metadata::connector_display_label(connector);
...
mod tests {
    ...
    use crate::bottom_pane::textarea::TextArea;
    use forestx_protocol::models::local_image_label_text;
    ...
    pub(super) fn new_test_composer() -> (ChatComposer, UnboundedReceiver<AppEvent>) {
        ...
        (
            ChatComposer::new(
                ...
                "Ask Forestx to do anything".to_string(),
        ...
        snapshot_composer_state(
            ...
            |composer| {
                ...
                composer.set_status_line(Some(Line::from(
                    "gpt-5.4 high fast · ~/code/forestx-1 · Context 0% used",
                )));
    ...
    fn status_line_hyperlink_marks_pr_number_cells() {
        ...
        let url = "https://github.com/openai/forestx/pull/20252";
        composer.set_status_line_enabled(/*enabled*/ true);
    ...
    fn set_skill_mentions_refreshes_open_mention_popup() {
        ...
        composer.set_skill_mentions(Some(vec![SkillMetadata {
            name: "forestx".to_string(),
            description: "Primary personal Forestx repo skill.".to_string(),
            short_description: None,
            interface: None,
            dependencies: None,
        ...
        assert_eq!(mention.insert_text, "$forestx".to_string());
    ...
    fn default_unified_mention_popup_snapshot() {
        snapshot_composer_state(
            ...
            /*enhanced_keys_supported*/ false,
            |composer| {
                let features = forestx_features::Features::with_defaults();
                composer
                    .set_mentions_v2_enabled(features.enabled(forestx_features::Feature::MentionsV2));
                composer.set_text_content("@sa".to_string(), Vec::new(), Vec::new());
                composer.set_plugin_mentions(Some(vec![PluginCapabilitySummary {
                    config_name: "sample@test".to_string(),
                    display_name: "Sample Plugin".to_string(),
...
程序员 与 Unicode 同行";
    ...
    fn file_completion_preserves_large_paste_placeholder_elements() {
        ...
        composer.on_file_search_result(
            ...
            vec![FileMatch {
                ...
                match_type: forestx_file_search::MatchType::File,
    ...
    fn pasting_filepath_attaches_image() {
        let tmp = tempdir().expect("create TempDir");
        let tmp_path: PathBuf = tmp.path().join("forestx_tui_test_paste_image.png");
