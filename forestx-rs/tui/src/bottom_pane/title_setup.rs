...
impl TerminalTitleItem {
    pub(crate) fn description(self) -> &'static str {
        match self {
            TerminalTitleItem::AppName => "Forestx app name",
            ...
            TerminalTitleItem::ForestxVersion => "Forestx application version",
    ...
    pub(crate) fn preview_item(self) -> Option<StatusSurfacePreviewItem> {
        match self {
            ...
            TerminalTitleItem::ForestxVersion => Some(StatusSurfacePreviewItem::ForestxVersion),
    ...
    fn parse_terminal_title_items_accepts_kebab_case_variants() {
        ...
        assert_eq!(
            ...
            Some(vec![
                ...
                TerminalTitleItem::WeeklyLimit,
                TerminalTitleItem::ForestxVersion,
