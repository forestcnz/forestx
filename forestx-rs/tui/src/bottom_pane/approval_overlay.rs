...
use forestx_app_server_protocol::FileSystemAccessMode;
use forestx_app_server_protocol::FileSystemPath;
use forestx_app_server_protocol::FileSystemSandboxEntry;
use forestx_app_server_protocol::FileSystemSpecialPath;
use forestx_app_server_protocol::McpServerElicitationAction;
use forestx_app_server_protocol::NetworkApprovalContext;
use forestx_app_server_protocol::NetworkApprovalProtocol;
    ...
    available_decisions
        ...
        .filter_map(|decision| match decision {
            ...
            CommandExecutionApprovalDecision::Cancel => Some(ApprovalOption {
                label: "No, and tell Forestx what to do differently".to_string(),
...
mod tests {
    ...
    use forestx_app_server_protocol::ExecPolicyAmendment;
    use forestx_app_server_protocol::NetworkApprovalProtocol;
    use forestx_app_server_protocol::NetworkPolicyAmendment;
    use forestx_config::types::KeybindingSpec;
    use forestx_config::types::KeybindingsSpec;
    ...
    fn network_exec_options_use_expected_labels_and_hide_execpolicy_amendment() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                "Yes, and allow this host for this conversation".to_string(),
                "Yes, and allow this host in the future".to_string(),
                "No, and tell Forestx what to do differently".to_string(),
            ]
        );
    }
    ...
    fn exec_history_cell_wraps_with_two_space_indent() {
        ...
        let rendered: Vec<String> = lines
            ...
            .collect();
        let expected = vec![
            "✔ You approved forestx to run".to_string(),
    ...
    fn network_access_command_history_uses_target_without_structured_context() {
        ...
        assert_eq!(
            ...
            vec![
                "✔ You approved forestx network access to https://example.com:8443 this time"
                    .to_string(),
            ]
        );
    }
