...
mod tests {
    ...
    fn test_pane_with_disable_paste_burst(
        ...
        BottomPane::new(BottomPaneParams {
            ...
            placeholder_text: "Ask Forestx to do anything".to_string(),
            disable_paste_burst,
    ...
    fn esc_with_skill_popup_does_not_interrupt_task() {
        ...
        while let Ok(ev) = rx.try_recv() {
            assert!(
                !matches!(ev, AppEvent::ForestxOp(Op::Interrupt)),
    ...
    fn esc_interrupts_running_task_when_no_popup() {
        ...
        assert!(
            matches!(rx.try_recv(), Ok(AppEvent::ForestxOp(Op::Interrupt))),
