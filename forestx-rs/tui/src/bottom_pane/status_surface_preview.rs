...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            StatusSurfacePreviewItem::AppName => "forestx",
            ...
            StatusSurfacePreviewItem::ForestxVersion => "0.0.0",
            ...
            StatusSurfacePreviewItem::Model => "gpt-5.2-forestx",
            StatusSurfacePreviewItem::ModelWithReasoning => "gpt-5.2-forestx medium",
