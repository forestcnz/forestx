...
/// Restore the terminal after Forestx is exiting.
///
...
impl Tui {
    pub(crate) fn new(
        ...
        let is_zellij = forestx_terminal_detection::terminal_info().is_zellij();
    ...
    /// terminal modes and stderr while keeping raw mode enabled, then re-applies Forestx TUI modes
