...
use forestx_app_server_protocol::HookOutputEntry;
use forestx_app_server_protocol::HookOutputEntryKind;
use forestx_app_server_protocol::HookRunStatus;
use forestx_app_server_protocol::HookRunSummary;
use ratatui::prelude::*;
    ...
    fn completed_hook_short_multiline_context_preserves_display_transcript_and_raw_lines() {
        let cell = completed_hook_cell(
            ...
            vec![HookOutputEntry {
                ...
                text: "## Working Memory Recall\n\nSource: Forestx compaction".to_string(),
            }],
        );
        let expected = vec![
