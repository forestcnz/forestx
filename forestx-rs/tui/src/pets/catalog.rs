//! Built-in pet catalog ported from the Forestx App avatar catalog.
...
pub(super) const BUILTIN_PETS: &[BuiltinPet] = &[
    BuiltinPet {
        id: "forestx",
        display_name: "Forestx",
        description: "The original Forestx companion",
        spritesheet_file: "forestx-spritesheet-v4.webp",
    },
    BuiltinPet {
        id: "dewey",
        display_name: "Dewey",
