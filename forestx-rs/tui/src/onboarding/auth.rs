...
use forestx_app_server_protocol::AuthMode as ApiAuthMode;
...
fn onboarding_request_id() -> forestx_app_server_protocol::RequestId {
    forestx_app_server_protocol::RequestId::String(Uuid::new_v4().to_string())
}
...
pub(super) async fn cancel_login_attempt(
    ...
    let _ = request_handle
        .request_typed::<forestx_app_server_protocol::CancelLoginAccountResponse>(
...
impl AuthModeWidget {
    ...
    fn render_pick_mode(&self, area: Rect, buf: &mut Buffer) {
        let mut lines: Vec<Line> = vec![
            Line::from(vec![
                "  ".into(),
                "Sign in with ChatGPT to use Forestx as part of your paid plan".into(),
            ]),
            Line::from(vec![
                "  ".into(),
    ...
    fn render_chatgpt_success_message(&self, area: Rect, buf: &mut Buffer) {
        ...
        docs_line.push_span(
            "Forestx docs".underlined(),
            Some("https://developers.openai.com/forestx/security"),
        );
        ...
        let lines = vec![
            ...
            "".into(),
            "  Decide how much autonomy you want to grant Forestx".into(),
            docs_line,
            "".into(),
            "  Forestx can make mistakes".into(),
            HyperlinkLine::new(
    ...
    fn render_api_key_configured(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  Forestx will use usage-based billing with your API key.".into(),
        ];
...
mod tests {
    ...
    const PRODUCTION_LENGTH_AUTH_URL: &str = concat!(
        ...
        "forestx_cli_simplified_flow=true&",
        "state=8cHjQ4nVx2Yp7Lm9Rk3Wf6Ta1Bs5Du0Ei4Go7Nz2PqM&",
        "originator=forestx_cli_rs"
    );
    ...
    async fn widget_forced_chatgpt() -> (AuthModeWidget, TempDir) {
        ...
        let config = ConfigBuilder::default()
            .forestx_home(forestx_home_path.clone())
            .build()
            .await
            .unwrap();
        ...
        let client = InProcessAppServerClient::start(InProcessClientStartArgs {
            ...
            environment_manager: Arc::new(
                forestx_app_server_client::EnvironmentManager::default_for_tests(),
            ),
    ...
    fn chatgpt_success_message_renders_osc8_hyperlinks() {
        ...
        assert_eq!(
            collect_osc8_chars(&buf, area, "https://developers.openai.com/forestx/security"),
            "Forestx docs"
        );
        assert_eq!(
        ...
        ✓ Signed in with your ChatGPT account
          ...
          Decide how much autonomy you want to grant Forestx
          For more details see the Forestx docs

          Forestx can make mistakes
          Review the code it writes and commands it runs
