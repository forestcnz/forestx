...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: forestx_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<forestx_protocol::openai_models::ReasoningEffort>,
