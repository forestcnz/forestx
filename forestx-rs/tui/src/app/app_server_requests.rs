...
mod tests {
    ...
    use forestx_app_server_protocol::McpElicitationObjectType;
    use forestx_app_server_protocol::McpElicitationSchema;
    ...
    use forestx_app_server_protocol::PermissionGrantScope;
    use forestx_app_server_protocol::PermissionsRequestApprovalParams;
    use forestx_app_server_protocol::PermissionsRequestApprovalResponse;
    use forestx_app_server_protocol::RequestId as AppServerRequestId;
    use forestx_app_server_protocol::ServerRequest;
    use forestx_app_server_protocol::ToolRequestUserInputAnswer;
    ...
    fn rejects_permissions_with_paths_that_cannot_be_localized() {
        ...
        let permissions = forestx_app_server_protocol::RequestPermissionProfile {
            network: None,
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
        ...
        let permissions = pending
            .take_resolution(&Op::RequestPermissionsResponse {
                id: "perm-1".to_string(),
                response: forestx_protocol::request_permissions::RequestPermissionsResponse {
                    ...
                    scope: forestx_protocol::request_permissions::PermissionGrantScope::Session,
        ...
        assert_eq!(
            ...
            PermissionsRequestApprovalResponse {
                permissions: forestx_app_server_protocol::GrantedPermissionProfile {
                    ...
                    file_system: Some(AdditionalFileSystemPermissions {
                        ...
                        glob_scan_max_depth: None,
                        entries: Some(vec![
                            forestx_app_server_protocol::FileSystemSandboxEntry {
                                path: forestx_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(read_path).into(),
                                },
                                access: forestx_app_server_protocol::FileSystemAccessMode::Read,
                            },
                            forestx_app_server_protocol::FileSystemSandboxEntry {
                                path: forestx_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(write_path).into(),
                                },
                                access: forestx_app_server_protocol::FileSystemAccessMode::Write,
                            },
                        ]),
                    }),
                },
    ...
    fn does_not_mark_chatgpt_auth_refresh_as_unsupported() {
        ...
        assert_eq!(
            pending.note_server_request(&ServerRequest::ChatgptAuthTokensRefresh {
                ...
                params: forestx_app_server_protocol::ChatgptAuthTokensRefreshParams {
                    reason: forestx_app_server_protocol::ChatgptAuthTokensRefreshReason::Unauthorized,
