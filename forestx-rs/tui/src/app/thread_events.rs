...
impl ThreadEventStore {
    ...
    pub(super) fn file_change_changes(
        ...
        turn_id: &str,
        item_id: &str,
    ) -> Option<Vec<forestx_app_server_protocol::FileUpdateChange>> {
        self.buffer
            .iter()
            .rev()
...
mod tests {
    ...
    use forestx_app_server_protocol::HookEventName as AppServerHookEventName;
    use forestx_app_server_protocol::HookExecutionMode as AppServerHookExecutionMode;
    use forestx_app_server_protocol::HookHandlerType as AppServerHookHandlerType;
    use forestx_app_server_protocol::HookOutputEntry as AppServerHookOutputEntry;
    use forestx_app_server_protocol::HookOutputEntryKind as AppServerHookOutputEntryKind;
    use forestx_app_server_protocol::HookRunStatus as AppServerHookRunStatus;
    use forestx_app_server_protocol::HookRunSummary as AppServerHookRunSummary;
    use forestx_app_server_protocol::HookScope as AppServerHookScope;
    use forestx_app_server_protocol::HookStartedNotification;
    use forestx_app_server_protocol::McpToolCallProgressNotification;
    ...
    fn thread_event_store_rebase_preserves_mcp_startup_notifications() {
        ...
        let notification = ServerNotification::McpServerStatusUpdated(
            forestx_app_server_protocol::McpServerStatusUpdatedNotification {
                thread_id: Some(thread_id.to_string()),
                name: "sentry".to_string(),
                status: forestx_app_server_protocol::McpServerStartupState::Failed,
