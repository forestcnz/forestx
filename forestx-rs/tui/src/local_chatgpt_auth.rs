...
mod tests {
    ...
    fn write_chatgpt_auth(forestx_home: &Path, plan_type: &str) {
        ...
        let auth = AuthDotJson {
            ...
            tokens: Some(TokenData {
                id_token: forestx_login::token_data::parse_chatgpt_jwt_claims(&id_token)
    ...
    fn loads_local_chatgpt_auth_from_managed_auth() {
        ...
        write_chatgpt_auth(forestx_home.path(), "business");
    ...
    fn preserves_usage_based_plan_type_wire_name() {
        let forestx_home = TempDir::new().expect("tempdir");
        write_chatgpt_auth(forestx_home.path(), "self_serve_business_usage_based");
