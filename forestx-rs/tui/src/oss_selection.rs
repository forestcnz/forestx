...
use forestx_model_provider_info::DEFAULT_LMSTUDIO_PORT;
use forestx_model_provider_info::DEFAULT_OLLAMA_PORT;
...
mod tests {
    ...
    async fn localhost_probe_succeeds_with_invalid_inherited_ca_bundle() {
        const CHILD_ENV: &str = "FORESTX_OSS_SELECTION_INVALID_CA_TEST_CHILD";
