...
mod tests {
    ...
    use forestx_app_server_protocol::PluginsMigration;
    use forestx_app_server_protocol::SessionMigration;
    use crossterm::event::KeyCode;
    use crossterm::event::KeyEvent;
    use crossterm::event::KeyModifiers;
    ...
    fn sample_plugin_details() -> forestx_app_server_protocol::MigrationDetails {
        forestx_app_server_protocol::MigrationDetails {
            plugins: vec![
                PluginsMigration {
    ...
    fn sample_items() -> Vec<ExternalAgentConfigMigrationItem> {
        ...
        vec![
            ExternalAgentConfigMigrationItem {
                ...
                description:
                    "Migrate /Users/alex/.claude/settings.json into /Users/alex/.forestx/config.toml"
                        .to_string(),
                cwd: None,
                details: None,
            },
            ExternalAgentConfigMigrationItem {
                ...
                cwd: None,
                details: Some(forestx_app_server_protocol::MigrationDetails {
    ...
    fn sample_items_with_memory() -> Vec<ExternalAgentConfigMigrationItem> {
        ...
        items.insert(
            ...
            ExternalAgentConfigMigrationItem {
                ...
                description: "Migrate memory files from /Users/alex/.claude/projects to /Users/alex/.forestx/memories/extensions/external_agent_import/resources".to_string(),
                cwd: None,
                details: Some(forestx_app_server_protocol::MigrationDetails {
    ...
    fn secondary_source_customize_snapshot() {
        let items = vec![ExternalAgentConfigMigrationItem {
            item_type: ExternalAgentConfigMigrationItemType::Config,
            description:
                "Migrate /Users/alex/.cursor/cli-config.json into /Users/alex/.forestx/config.toml"
                    .to_string(),
            cwd: None,
            details: None,
        }];
