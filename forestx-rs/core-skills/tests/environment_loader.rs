...
async fn host_loading_reuses_walk_inventory_for_symlinked_skill_pack() {
    ...
    use forestx_core_skills::SkillPolicy;
    ...
    let manifest_path = shared_plugin_root.path().join(".forestx-plugin/plugin.json");
    ...
    let future = load_skills_from_roots(
        [SkillRoot {
            ...
            plugin_root: None,
            discovery_mode: forestx_utils_plugins::SkillDiscoveryMode::Recursive,
        }],
