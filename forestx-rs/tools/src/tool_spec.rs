...
use forestx_protocol::config_types::WebSearchFilters as ConfigWebSearchFilters;
use forestx_protocol::config_types::WebSearchUserLocation as ConfigWebSearchUserLocation;
use forestx_protocol::config_types::WebSearchUserLocationType;
use serde::Serialize;
