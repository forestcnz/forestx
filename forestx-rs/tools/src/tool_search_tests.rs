...
fn default_search_text_uses_model_visible_namespace_metadata_once() {
    ...
    let spec = ToolSpec::Namespace(crate::ResponsesApiNamespace {
        ...
        description: "Manage Forestx automations.".to_string(),
        tools: vec![ResponsesApiNamespaceTool::Function(ResponsesApiTool {
    ...
    assert_eq!(
        ...
        "forestx_app Manage Forestx automations. automation_update automation update Create or update automations. Automation options. mode Update mode. schedule Schedule settings. timezone IANA timezone."
    );
}
