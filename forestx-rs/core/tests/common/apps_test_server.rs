use crate::test_forestx::TestForestxBuilder;
use crate::test_forestx::test_forestx;
use anyhow::Result;
...
const FORESTX_APPS_META_KEY: &str = "_forestx_apps";
const FORESTX_APPS_MCP_PATH_REGEX: &str = "^/api/forestx/ps/mcp/?$";
const HOSTED_PLUGIN_RUNTIME_MCP_PATH_REGEX: &str = "^/api/forestx/ps/mcp/?$";
const PROTOCOL_VERSION: &str = "2025-11-25";
const SERVER_NAME: &str = "forestx-apps-test";
...
pub const DIRECT_CALENDAR_CREATE_EVENT_TOOL: &str = "mcp__forestx_apps__calendar__create_event";
pub const DIRECT_CALENDAR_APP_ONLY_TOOL: &str = "mcp__forestx_apps__calendar__app_only_action";
pub const DIRECT_CALENDAR_LIST_EVENTS_TOOL: &str = "mcp__forestx_apps__calendar__list_events";
pub const DIRECT_CALENDAR_EXTRACT_TEXT_TOOL: &str = "mcp__forestx_apps__calendar__extract_text";
pub const SEARCH_CALENDAR_NAMESPACE: &str = "mcp__forestx_apps__calendar";
...
pub fn apps_enabled_builder(apps_base_url: impl Into<String>) -> TestForestxBuilder {
...
pub fn search_capable_apps_builder(apps_base_url: impl Into<String>) -> TestForestxBuilder {
    let apps_base_url = apps_base_url.into();
    test_forestx()
        .with_auth(ForestxAuth::create_dummy_chatgpt_auth_for_testing())
...
pub async fn recorded_apps_tool_calls(server: &MockServer) -> Vec<Value> {
    server
        ...
        .filter_map(|request| {
            ...
            (request.url.path() == "/api/forestx/ps/mcp"
...
async fn mount_streamable_http_json_rpc_with_startup_control(
    ...
    Mock::given(method("POST"))
        ...
        .respond_with(ForestxAppsJsonRpcResponder {
            connector_name,
            connector_description,
            searchable,
            include_app_only_tool,
...
struct ForestxAppsJsonRpcResponder {
    connector_name: String,
    connector_description: String,
    searchable: bool,
    include_app_only_tool: bool,
...
impl Respond for ForestxAppsJsonRpcResponder {
        ...
        match method {
            ...
            "tools/call" => {
                ...
                let file_id = body
                    ...
                    .and_then(Value::as_str)
                    .unwrap_or_default();
                let forestx_apps_meta = body.pointer("/params/_meta/_forestx_apps").cloned();
                ...
                ResponseTemplate::new(200).set_body_json(json!({
                    ...
                    "result": {
                        ...
                        "structuredContent": {
                            "_forestx_apps": forestx_apps_meta,
                        },
                        "isError": false
                    }
                }))
