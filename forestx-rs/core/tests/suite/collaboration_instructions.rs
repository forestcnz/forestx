...
use forestx_protocol::openai_models::CollaborationModeMessages;
use forestx_protocol::openai_models::ModelMessages;
use forestx_protocol::openai_models::ModelsResponse;
use forestx_protocol::protocol::COLLABORATION_MODE_CLOSE_TAG;
            ...
            thread_settings: forestx_protocol::protocol::ThreadSettingsOverrides {
                ...
                summary: Some(
                    test.config
                        ...
                        .unwrap_or(forestx_protocol::config_types::ReasoningSummary::Auto),
                ),
                collaboration_mode: Some(collaboration_mode),
                ..Default::default()
            },
