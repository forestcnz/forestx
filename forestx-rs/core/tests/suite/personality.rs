...
use forestx_protocol::openai_models::ModelInstructionsVariables;
...
async fn user_turn_personality_some_adds_update_message() -> anyhow::Result<()> {
    ...
    .await;
    let mut builder = test_forestx()
        .with_model("exp-forestx-personality")
        .with_config(|config| {
            config
                .features
                .enable(Feature::Personality)
...
async fn disabled_personality_sends_remote_default_instructions() -> anyhow::Result<()> {
    ...
    let mut builder = test_forestx()
        .with_auth(forestx_login::ForestxAuth::create_dummy_chatgpt_auth_for_testing())
...
async fn remote_model_friendly_personality_instructions_with_feature() -> anyhow::Result<()> {
    ...
    let remote_slug = "forestx-remote-default-personality";
...
async fn user_turn_personality_remote_model_template_includes_update_message() -> anyhow::Result<()>
{
    ...
    let remote_slug = "forestx-remote-personality";
