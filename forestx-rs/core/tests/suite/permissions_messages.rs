...
use forestx_core::context::ApprovalPromptContext;
use forestx_core::context::ContextualUserFragment;
use forestx_core::context::PermissionsInstructions;
use forestx_core::load_exec_policy;
use forestx_models_manager::model_info::model_info_from_slug;
use forestx_protocol::models::PermissionProfile;
use forestx_protocol::openai_models::ApprovalMessages;
use forestx_protocol::openai_models::ModelMessages;
use forestx_protocol::openai_models::ModelsResponse;
use forestx_protocol::openai_models::PermissionMessages;
...
) -> forestx_protocol::openai_models::ModelInfo {
