...
async fn forestx_apps_auth_failure_requests_elicitation_by_default() -> Result<()> {
...
"#,
    ...
    assert_eq!(
        request.id,
        forestx_protocol::mcp::RequestId::String(format!("forestx_apps_auth_{call_id}"))
    );
    assert_eq!(
        request.request,
        ElicitationRequest::Url {
            ...
            elicitation_id: format!("forestx_apps_auth_{call_id}"),
        }
    );
