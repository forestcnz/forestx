...
async fn ultra_reasoning_uses_max_and_proactive_mode() -> Result<()> {
    ...
    submit_turn(&test.forestx, "hello", /*effort*/ None).await?;
...
async fn configured_mode_hint_uses_custom_mode_across_reasoning_efforts() -> Result<()> {
    ...
    let test = test_forestx()
        ...
        .build(&server)
        .await?;
    submit_turn(&test.forestx, "explicit", Some(ReasoningEffort::High)).await?;
    submit_turn(&test.forestx, "proactive", Some(ReasoningEffort::Ultra)).await?;
...
async fn empty_configured_mode_hint_emits_no_mode_message() -> Result<()> {
    ...
    submit_turn(&test.forestx, "hello", Some(ReasoningEffort::High)).await?;
...
async fn changing_configured_mode_hint_to_empty_emits_no_update() -> Result<()> {
    ...
    submit_turn(&initial.forestx, "before resume", /*effort*/ None).await?;
    ...
    drop(initial);
    submit_turn(&resumed.forestx, "after resume", /*effort*/ None).await?;
...
async fn live_mode_change_appends_mode_without_reappending_usage_hint() -> Result<()> {
    ...
    submit_turn(&test.forestx, "proactive", /*effort*/ None).await?;
    submit_turn(&test.forestx, "explicit", Some(ReasoningEffort::High)).await?;
...
async fn leaving_ultra_after_cold_resume_emits_explicit_mode() -> Result<()> {
    ...
    let resumed = resume_builder.restart(&server, &initial).await?;
    drop(initial);
    submit_turn(&resumed.forestx, "after resume", Some(ReasoningEffort::High)).await?;
