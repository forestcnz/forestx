...
use forestx_protocol::items::WebSearchItem;
...
use forestx_protocol::models::is_audio_close_tag_text;
use forestx_protocol::models::is_audio_open_tag_text;
use forestx_protocol::models::is_image_close_tag_text;
use forestx_protocol::models::is_image_open_tag_text;
use forestx_protocol::models::is_local_audio_close_tag_text;
use forestx_protocol::models::is_local_audio_open_tag_text;
use forestx_protocol::models::is_local_image_close_tag_text;
use forestx_protocol::models::is_local_image_open_tag_text;
use forestx_protocol::protocol::APPS_INSTRUCTIONS_OPEN_TAG;
use forestx_protocol::protocol::COLLABORATION_MODE_OPEN_TAG;
...
use forestx_protocol::protocol::PLUGINS_INSTRUCTIONS_OPEN_TAG;
use forestx_protocol::protocol::REALTIME_CONVERSATION_OPEN_TAG;
use forestx_protocol::protocol::SKILLS_INSTRUCTIONS_OPEN_TAG;
use forestx_protocol::protocol::TOOLS_OPEN_TAG;
...
pub fn parse_turn_item(item: &ResponseItem) -> Option<TurnItem> {
    match item {
        ...
        ResponseItem::ImageGenerationCall {
            ...
            forestx_protocol::items::ImageGenerationItem {
