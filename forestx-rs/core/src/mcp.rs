...
use forestx_connectors::PluginConnectorSource;
...
use forestx_mcp::forestx_apps_mcp_server_config;
use forestx_mcp::configured_mcp_servers;
...
const LEGACY_FORESTX_APPS_REGISTRATION_ID: &str = "legacy_forestx_apps";
...
impl McpManager {
    pub fn new(plugins_manager: Arc<PluginsManager>) -> Self {
        Self::new_with_extensions(
            plugins_manager,
            forestx_extension_api::empty_extension_registry(),
    ...
    pub fn forestx_apps_tools_cache(&self) -> ConnectorRuntimeManager<ToolInfo> {
        self.forestx_apps_tools_cache.clone()
    }
    ...
    async fn runtime_config_with_context(
        ...
        if mcp_config.apps_enabled {
            catalog.register(McpServerRegistration::from_compatibility(
                ...
                LEGACY_FORESTX_APPS_REGISTRATION_ID,
