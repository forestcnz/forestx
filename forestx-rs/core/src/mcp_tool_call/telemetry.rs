...
const MCP_CALL_COUNT_METRIC: &str = "forestx.mcp.call";
const MCP_CALL_DURATION_METRIC: &str = "forestx.mcp.call.duration_ms";
const MCP_CALL_ERROR_COUNT_METRIC: &str = "forestx.mcp.call.error";
...
const MCP_CALL_ERROR_CODE_SPAN_ATTR: &str = "forestx.mcp.error.code";
            ...
            let error_code = result
                ...
                .or_else(|| {
                    result
                        ...
                        .and_then(JsonValue::as_object)
                        .and_then(|forestx_apps| forestx_apps.get("connector_auth_failure"))
                        .and_then(JsonValue::as_object)
                        .filter(|auth_failure| {
                            auth_failure
                                .get("is_auth_failure")
