...
pub(crate) struct PendingUserMessageAdmissions {
    pending: Mutex<HashMap<String, oneshot::Sender<ForestxResult<UserMessageAdmission>>>>,
}
...
impl PendingUserMessageAdmissions {
    pub(crate) fn register(
        ...
        oneshot::Receiver<ForestxResult<UserMessageAdmission>>,
    ) {
    ...
    pub(crate) fn complete(
        &self,
        submission_id: &str,
        admission: ForestxResult<UserMessageAdmission>,
    ) {
