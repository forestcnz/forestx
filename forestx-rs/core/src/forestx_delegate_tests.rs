...
use forestx_protocol::protocol::GuardianAssessmentAction;
...
use forestx_protocol::request_user_input::RequestUserInputEvent;
...
#[tokio::test]
async fn run_forestx_thread_interactive_respects_pre_cancelled_spawn() {
    ...
    let result = timeout(
        ...
        run_forestx_thread_interactive(
