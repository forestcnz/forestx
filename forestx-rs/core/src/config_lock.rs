...
pub(crate) struct ConfigLockReplayOptions {
    pub allow_forestx_version_mismatch: bool,
}
...
pub(crate) fn validate_config_lock_replay(
    ...
    if !options.allow_forestx_version_mismatch
        && expected_lock.forestx_version != actual_lock.forestx_version
    {
        return Err(config_lock_error(format!(
            "config lock Forestx version mismatch: lock was generated by {}, current version is {}; set debug.config_lockfile.allow_forestx_version_mismatch=true to ignore this",
            expected_lock.forestx_version, actual_lock.forestx_version
        )));
    }
...
fn config_lock_for_comparison(
    ...
    if options.allow_forestx_version_mismatch {
        lockfile.forestx_version.clear();
    }
    lockfile
}
