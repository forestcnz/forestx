...
use forestx_prompts::render_review_exit_interrupted;
use forestx_prompts::render_review_exit_success;
...
use forestx_protocol::review_format::format_review_findings_block;
use forestx_protocol::review_format::render_review_output_text;
use tokio_util::sync::CancellationToken;

use crate::forestx_delegate::run_forestx_thread_one_shot;
...
impl SessionTask for ReviewTask {
    ...
    async fn run(
        ...
        session
            .services
            .session_telemetry
            .counter("forestx.task.review", /*inc*/ 1, &[]);
        ...
        // Start sub-forestx conversation and get the receiver for events.
