...
use forestx_shell_command::powershell::extract_powershell_command;

const CANONICAL_BASH_SCRIPT_PREFIX: &str = "__forestx_shell_script__";
const CANONICAL_POWERSHELL_SCRIPT_PREFIX: &str = "__forestx_powershell_script__";
