...
) -> forestx_tools::ToolUserShellType {
    match user_shell.shell_type {
        crate::shell::ShellType::Zsh => forestx_tools::ToolUserShellType::Zsh,
        crate::shell::ShellType::Bash => forestx_tools::ToolUserShellType::Bash,
        crate::shell::ShellType::PowerShell => forestx_tools::ToolUserShellType::PowerShell,
        crate::shell::ShellType::Sh => forestx_tools::ToolUserShellType::Sh,
        crate::shell::ShellType::Cmd => forestx_tools::ToolUserShellType::Cmd,
    }
}
