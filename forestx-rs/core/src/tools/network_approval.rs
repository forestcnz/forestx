...
use forestx_network_proxy::BlockedRequest;
...
use forestx_sandboxing::record_network_sandbox_violation;
...
pub(crate) async fn begin_network_approval(
    ...
    let execution_proxy = network
        ...
        .map_err(|err| {
            ToolError::Forestx(forestx_protocol::error::ForestxErr::Io(io::Error::other(
