...
//!
//! `forestx-rollout-trace` owns the event schema and writer behavior. This module
...
use forestx_rollout_trace::ToolDispatchInvocation;
use forestx_rollout_trace::ToolDispatchPayload;
use forestx_rollout_trace::ToolDispatchRequester;
use forestx_rollout_trace::ToolDispatchResult;
use forestx_rollout_trace::ToolDispatchTraceContext;
...
fn tool_dispatch_invocation(invocation: &ToolInvocation) -> Option<ToolDispatchInvocation> {
    ...
    Some(ToolDispatchInvocation {
        ...
        forestx_turn_id: invocation.turn.sub_id.clone(),
