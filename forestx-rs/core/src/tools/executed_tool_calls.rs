...
use forestx_protocol::models::ExecutedToolCall;
use forestx_protocol::models::ResponseItem;
use forestx_protocol::models::bound_executed_tool_calls_for_prompt_prioritizing_recent;
use forestx_protocol::models::executed_tool_call_metadata_bytes;
...
impl ExecutedToolCallRecorder {
    pub(crate) fn record_tool_call(
        ...
        let name = forestx_tools::code_mode_name_for_tool_name(&call.tool_name);
