...
use forestx_protocol::items::DynamicToolCallStatus;
...
use forestx_tools::dynamic_tool_to_responses_api_tool;
    ...
    fn search_info(&self) -> Option<ToolSearchInfo> {
        ToolSearchInfo::from_tool_spec(
            ...
            Some(ToolSearchSourceInfo {
                ...
                description: Some("Tools provided by the current Forestx thread.".to_string()),
            }),
        )
    }
