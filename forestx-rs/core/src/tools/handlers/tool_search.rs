...
use forestx_tools::LoadableToolSpec;
use forestx_tools::TOOL_SEARCH_DEFAULT_LIMIT;
use forestx_tools::TOOL_SEARCH_TOOL_NAME;
use forestx_tools::ToolName;
use forestx_tools::ToolSearchEntry;
use forestx_tools::ToolSearchInfo;
use forestx_tools::ToolSpec;
use forestx_tools::coalesce_loadable_tool_specs;
use std::sync::Arc;
use std::sync::Mutex;
...
mod tests {
    ...
    fn mixed_search_results_coalesce_mcp_namespaces() {
        let dynamic_namespace = DynamicToolNamespaceSpec {
            ...
            description: "Tools in the forestx_app namespace.".to_string(),
            tools: Vec::new(),
        };
