...
fn search_info_uses_mcp_tool_metadata_and_parameter_names() {
    ...
    assert_eq!(
        ...
        "mcp__calendar___create_event _create_event createEvent forestx-apps Create event Create a calendar event. Calendar Plan events. Calendar plugin attendees start_time"
    );
    assert_eq!(
...
fn tool_info() -> ToolInfo {
    ToolInfo {
        server_name: "forestx-apps".to_string(),
