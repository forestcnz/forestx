...
impl ExecCommandHandler {
    async fn handle_call(
        ...
        let command_for_display = forestx_shell_command::parse_command::shlex_join(&command);
        ...
        if effective_additional_permissions
            ...
            && !matches!(
                ...
                forestx_protocol::protocol::AskForApproval::OnRequest
            )
        {
