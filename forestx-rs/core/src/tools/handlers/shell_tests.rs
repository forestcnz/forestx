...
use forestx_shell_command::powershell::try_find_powershell_executable_blocking;
use forestx_shell_command::powershell::try_find_pwsh_executable_blocking;
...
async fn shell_command_handler_to_exec_params_uses_selected_environment() {
    ...
    assert_eq!(
        exec_params.env.get(FORESTX_PERMISSION_PROFILE_ENV_VAR),
...
async fn shell_command_pre_tool_use_payload_uses_raw_command() {
    ...
    let handler = ShellCommandHandler::from(forestx_tools::ShellCommandBackendConfig::Classic);
