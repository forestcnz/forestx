...
use forestx_analytics::CodeModeToolCallFact;
use forestx_analytics::CodeModeToolCallStatus;
...
impl CodeModeToolCallGuard {
    pub(super) fn new(
        ...
        Self {
            ...
            cell_id: None,
            tool_name,
            started_at_ms: forestx_analytics::now_unix_millis(),
    ...
    fn drop(&mut self) {
        self.analytics
            .track_code_mode_tool_call(CodeModeToolCallFact::Completed {
                ...
                completed_at_ms: forestx_analytics::now_unix_millis(),
                status: self.status,
            });
    }
}
