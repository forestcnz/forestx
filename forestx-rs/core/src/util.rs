...
/// `forestx_feedback::ForestxFeedback::metadata_layer()` is installed, these fields are captured and
...
///
/// forestx_core::feedback_tags!(model = "gpt-5", cached = true);
/// forestx_core::feedback_tags!(provider = provider_id, request_id = request_id);
/// ```
#[macro_export]
