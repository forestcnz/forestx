...
impl<T: HttpTransport> ModelsClient<T> {
    ...
    fn append_client_version_query(req: &mut forestx_client::Request, client_version: &str) {
...
mod tests {
    ...
    async fn appends_client_version_query() {
        ...
        let provider = provider("https://example.com/api/forestx");
        ...
        assert_eq!(
            url,
            "https://example.com/api/forestx/models?client_version=0.99.0"
        );
    }
