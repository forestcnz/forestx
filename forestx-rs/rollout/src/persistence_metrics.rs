...
const ITEM_BYTES_METRIC: &str = "forestx.rollout.persistence.item_bytes";
const APPEND_METRIC: &str = "forestx.rollout.persistence.append";
const TURN_BYTES_METRIC: &str = "forestx.rollout.persistence.turn_bytes";
const MEASUREMENT_ERROR_METRIC: &str = "forestx.rollout.persistence.measurement_error";
...
impl RolloutPersistenceTelemetry {
    pub fn new(thread_id: ThreadId) -> Self {
        let metrics = forestx_otel::global();
