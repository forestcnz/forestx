//! Captures how this Forestx process was launched.
//!
...
/// Builds the process provenance row for the current Forestx executable.
///
...
pub(super) fn search_check() -> DoctorCheck {
    ...
    if status != CheckStatus::Ok {
        check = check.remediation("Install ripgrep or repair the bundled Forestx package.");
    }
    check
}
...
fn build_commit() -> &'static str {
    option_env!("FORESTX_BUILD_COMMIT")
