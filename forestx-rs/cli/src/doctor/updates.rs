//! Diagnoses whether Forestx update paths target the running installation.
//!
...
const GITHUB_LATEST_RELEASE_URL: &str = "https://api.github.com/repos/openai/forestx/releases/latest";
const HOMEBREW_CASK_API_URL: &str = "https://formulae.brew.sh/api/cask/forestx.json";
...
pub(super) fn updates_check(config: &Config) -> DoctorCheck {
    ...
    let version_file = config.forestx_home.join(VERSION_FILE_NAME);
...
fn update_action_label(context: &InstallContext) -> &'static str {
    match &context.method {
        InstallMethod::Npm => "npm install -g @openai/forestx",
        InstallMethod::Bun => "bun install -g @openai/forestx",
        InstallMethod::Pnpm => "pnpm add -g @openai/forestx",
        InstallMethod::Brew => "brew upgrade --cask forestx",
