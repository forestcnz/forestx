...
pub use forestx_utils_path::is_wsl;
...
mod tests {
    ...
    fn win_to_wsl_basic() {
        assert_eq!(
            win_path_to_wsl(r"C:\Temp\forestx.zip").as_deref(),
            Some("/mnt/c/Temp/forestx.zip")
        );
        assert_eq!(
            win_path_to_wsl("D:/Work/forestx.tgz").as_deref(),
            Some("/mnt/d/Work/forestx.tgz")
        );
        assert!(win_path_to_wsl("/home/user/forestx").is_none());
    }
