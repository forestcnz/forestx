...
#[test]
fn forestx_hooks_is_legacy_alias_for_hooks() {
    assert_eq!(feature_for_key("hooks"), Some(Feature::ForestxHooks));
    assert_eq!(feature_for_key("forestx_hooks"), Some(Feature::ForestxHooks));
}
