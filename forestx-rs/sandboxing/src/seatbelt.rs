...
use forestx_network_proxy::PROXY_URL_ENV_KEYS;
use forestx_network_proxy::has_proxy_url_env_vars;
use forestx_network_proxy::proxy_url_env_value;
...
fn build_seatbelt_access_policy(
    ...
    for (index, access_root) in roots.into_iter().enumerate() {
            ...
            access_root.excluded_subpaths.into_iter().enumerate()
        {
            ...
            // protected directory itself, such as `mkdir .forestx`.
