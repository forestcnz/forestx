...
const CLOUD_CONFIG_BUNDLE_CACHE_WRITE_HMAC_KEY: &[u8] =
    b"forestx-cloud-config-bundle-cache-v1-6160ae70-bcfd-4ca8-a99b-40f73b3b072e";
...
impl CloudConfigBundleCache {
    pub(super) fn new(forestx_home: AbsolutePathBuf) -> Self {
        Self {
            path: forestx_home.join(CLOUD_CONFIG_BUNDLE_CACHE_FILENAME),
        }
    }
