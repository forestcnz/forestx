...
use forestx_login::token_data::IdTokenInfo;
...
const SYSTEM_PROXY_TEST_SUBPROCESS_ENV_VAR: &str = "FORESTX_AUTH_SYSTEM_PROXY_TEST_SUBPROCESS";
const SYSTEM_PROXY_TEST_PROXY_URL_ENV_VAR: &str = "FORESTX_AUTH_SYSTEM_PROXY_TEST_PROXY_URL";
...
async fn refresh_token_honors_respect_system_proxy() -> Result<()> {
    ...
    let auth_manager = AuthManager::shared(
        ...
        /*auth_route_config*/
        forestx_login::AuthRouteConfig::from_http_client_factory(HttpClientFactory::new(
