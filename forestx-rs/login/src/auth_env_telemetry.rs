...
use crate::FORESTX_API_KEY_ENV_VAR;
...
impl AuthEnvTelemetry {
    pub fn to_otel_metadata(&self) -> AuthEnvTelemetryMetadata {
        AuthEnvTelemetryMetadata {
            ...
            forestx_api_key_env_present: self.forestx_api_key_env_present,
            forestx_api_key_env_enabled: self.forestx_api_key_env_enabled,
...
pub fn collect_auth_env_telemetry(
    ...
    forestx_api_key_env_enabled: bool,
) -> AuthEnvTelemetry {
    AuthEnvTelemetry {
        openai_api_key_env_present: env_var_present(OPENAI_API_KEY_ENV_VAR),
        forestx_api_key_env_present: env_var_present(FORESTX_API_KEY_ENV_VAR),
        forestx_api_key_env_enabled,
...
mod tests {
    ...
    fn collect_auth_env_telemetry_buckets_provider_env_key_name() {
        ...
        let telemetry =
            collect_auth_env_telemetry(&provider, /*forestx_api_key_env_enabled*/ false);
