    ...
    match msg {
        ...
        EventMsg::CollabAgentSpawnEnd(end_event) => {
            ...
            let status = match &end_event.status {
                forestx_protocol::protocol::AgentStatus::Errored(_)
                | forestx_protocol::protocol::AgentStatus::NotFound => {
        ...
        EventMsg::AgentMessageContentDelta(event) => {
            let forestx_protocol::protocol::AgentMessageContentDeltaEvent { item_id, delta, .. } =
                event;
...
mod tests {
    ...
    use forestx_protocol::protocol::CollabResumeBeginEvent;
    use forestx_protocol::protocol::CollabResumeEndEvent;
    ...
    fn collab_resume_end_maps_to_item_completed_resume_agent() {
        let event = CollabResumeEndEvent {
            ...
            receiver_agent_nickname: None,
            receiver_agent_role: None,
            status: forestx_protocol::protocol::AgentStatus::NotFound,
        };
        ...
        assert_item_completed_server_notification(
            ...
            ItemCompletedNotification {
                ...
                item: ThreadItem::CollabAgentToolCall {
                    ...
                    agents_states: [(
                        receiver_id,
                        CollabAgentState::from(forestx_protocol::protocol::AgentStatus::NotFound),
                    )]
                    .into_iter()
                    .collect(),
                },
