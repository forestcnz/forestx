...
pub use forestx_protocol::protocol::GitSha;
...
pub struct InitializeResponse {
    ...
    /// Absolute path to the server's $FORESTX_HOME directory.
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [forestx_protocol::protocol::PatchApplyBeginEvent]
    /// and [forestx_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [forestx_protocol::protocol::ExecCommandBeginEvent]
    /// and [forestx_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
