...
pub enum AuthMode {
    /// OpenAI API key provided by the caller and stored by Forestx.
    ApiKey,
    /// ChatGPT OAuth managed by Forestx (tokens persisted and refreshed by Forestx).
    Chatgpt,
    ...
    Headers,
    /// Programmatic Forestx auth backed by a registered Agent Identity.
    #[serde(rename = "agentIdentity")]
    #[ts(rename = "agentIdentity")]
    #[strum(serialize = "agentIdentity")]
    AgentIdentity,
    /// Programmatic Forestx auth backed by a personal access token.
    #[serde(rename = "personalAccessToken")]
    #[ts(rename = "personalAccessToken")]
    #[strum(serialize = "personalAccessToken")]
    PersonalAccessToken,
    /// Amazon Bedrock bearer token managed by Forestx.
...
impl AuthMode {
    ...
    /// Returns whether this mode is backed by Forestx services rather than a direct model API.
...
client_request_definitions! {
    ...
    /// Spawn a standalone process (argv vector) without a Forestx sandbox.
...
/// Superset of [`forestx_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by Forestx Cloud.
...
mod tests {
    ...
    fn jsonrpc_request_conversion_preserves_serde_enum_decoding() {
        let requests = [
            JSONRPCRequest {
                ...
                trace: Some(forestx_protocol::protocol::W3cTraceContext {
    ...
    fn serialize_mcp_server_elicitation_request() -> Result<()> {
        ...
        let params = v2::McpServerElicitationRequestParams {
            ...
            server_name: "forestx_apps".to_string(),
        ...
        let response = ClientResponse::ThreadStart {
            ...
            response: v2::ThreadStartResponse {
                ...
                instruction_sources: vec![
                    forestx_utils_path_uri::LegacyAppPathString::from_abs_path(&absolute_path(
                        "/tmp/AGENTS.md",
                    )),
                ],
    ...
    fn serialize_account_login_chatgpt_streamlined() -> Result<()> {
        let request = ClientRequest::LoginAccount {
            ...
            params: v2::LoginAccountParams::Chatgpt {
                app_brand: None,
                forestx_streamlined_login: true,
                use_hosted_login_success_page: false,
            },
        };
        assert_eq!(
    ...
    fn account_serializes_fields_in_camel_case() -> Result<()> {
        ...
        let forestx_managed_bedrock = v2::Account::AmazonBedrock {
            uses_forestx_managed_credentials: true,
        };
        assert_eq!(
            json!({
                "type": "amazonBedrock",
                "usesForestxManagedCredentials": true,
            }),
            serde_json::to_value(&forestx_managed_bedrock)?,
        );

        let externally_managed_bedrock = v2::Account::AmazonBedrock {
            uses_forestx_managed_credentials: false,
        };
        assert_eq!(
            json!({
                "type": "amazonBedrock",
                "usesForestxManagedCredentials": false,
            }),
    ...
    fn serialize_thread_realtime_start() -> Result<()> {
        let request = ClientRequest::ThreadRealtimeStart {
            ...
            params: v2::ThreadRealtimeStartParams {
                ...
                forestx_response_handoff_channel_prefixes: Some(std::collections::BTreeMap::from([
        ...
        assert_eq!(
            json!({
                ...
                "params": {
                    ...
                    "forestxResponsesAsItems": null,
                    "forestxResponseItemPrefix": null,
                    "forestxResponseHandoffMode": "bemTags",
        ...
        assert_eq!(
            json!({
                ...
                "params": {
                    ...
                    "forestxResponsesAsItems": null,
                    "forestxResponseItemPrefix": null,
                    "forestxResponseHandoffMode": null,
                    "forestxResponseHandoffChannelPrefixes": null,
                    "model": null,
                    "outputModality": "audio",
        ...
        let notification =
            ServerNotification::ThreadSettingsUpdated(v2::ThreadSettingsUpdatedNotification {
                ...
                thread_settings: v2::ThreadSettings {
                    ...
                    effort: None,
                    summary: None,
                    collaboration_mode: forestx_protocol::config_types::CollaborationMode {
