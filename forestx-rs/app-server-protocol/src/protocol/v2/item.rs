...
use forestx_experimental_api_macros::ExperimentalApi;
use forestx_extension_items::ExtensionItem;
pub use forestx_extension_items::image_generation::ImageGenerationItem;
pub use forestx_extension_items::sleep::SleepItem;
pub use forestx_extension_items::web_search::WebSearchAction;
pub use forestx_extension_items::web_search::WebSearchItem;
use forestx_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use forestx_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use forestx_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
...
use forestx_protocol::parse_command::ParsedCommand as CoreParsedCommand;
...
use forestx_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use forestx_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use forestx_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use forestx_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
pub(crate) fn web_search_action_from_core(
    value: forestx_protocol::models::WebSearchAction,
) -> WebSearchAction {
    match value {
        forestx_protocol::models::WebSearchAction::Search { query, queries } => {
            WebSearchAction::Search { query, queries }
        }
        forestx_protocol::models::WebSearchAction::OpenPage { url } => {
            WebSearchAction::OpenPage { url }
        }
        forestx_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
            WebSearchAction::FindInPage { url, pattern }
        }
        forestx_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
    }
}
...
impl From<forestx_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: forestx_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<forestx_protocol::dynamic_tools::DynamicToolCallOutputContentItem>
    for DynamicToolCallOutputContentItem
{
    fn from(item: forestx_protocol::dynamic_tools::DynamicToolCallOutputContentItem) -> Self {
        match item {
...
impl From<DynamicToolCallOutputContentItem>
    for forestx_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
