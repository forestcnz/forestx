...
use forestx_protocol::items::McpToolCallError as CoreMcpToolCallError;
use forestx_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use forestx_protocol::mcp::McpServerInfo;
use forestx_protocol::mcp::Resource as McpResource;
pub use forestx_protocol::mcp::ResourceContent as McpResourceContent;
use forestx_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use forestx_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from forestx_protocol::protocol::McpAuthStatus {
        Unknown,
        Unsupported,
        NotLoggedIn,
        BearerToken,
...
v2_enum_from_core!(
    pub enum McpServerStartupFailureReason from forestx_protocol::protocol::McpStartupFailureReason {
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> forestx_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => forestx_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => forestx_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => forestx_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active Forestx turn when this elicitation was observed, if app-server could correlate one.
    ///
