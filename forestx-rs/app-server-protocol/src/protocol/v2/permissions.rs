...
use crate::TS;
use forestx_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use forestx_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use forestx_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use forestx_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use forestx_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use forestx_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
use forestx_protocol::models::LegacyReadWriteRoots;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> forestx_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<forestx_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: forestx_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            forestx_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            forestx_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            forestx_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
