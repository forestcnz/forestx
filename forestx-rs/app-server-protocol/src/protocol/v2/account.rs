...
use forestx_protocol::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use forestx_protocol::protocol::RateLimitReachedType as CoreRateLimitReachedType;
use forestx_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use forestx_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
use forestx_protocol::protocol::SpendControlLimitSnapshot as CoreSpendControlLimitSnapshot;
...
pub enum Account {
    ...
    AmazonBedrock {
        #[serde(default)]
        uses_forestx_managed_credentials: bool,
    },
}
    ...
    fn from(account: ProviderAccount) -> Self {
        match account {
            ...
            ProviderAccount::AmazonBedrock {
                uses_forestx_managed_credentials,
            } => Self::AmazonBedrock {
                uses_forestx_managed_credentials,
            },
        }
...
pub enum LoginAccountParams {
    ...
    /// The access token must contain the same scopes that Forestx-managed ChatGPT auth tokens have.
    ...
    ChatgptAuthTokens {
        ...
        ///
        /// When `null`, Forestx attempts to derive the plan type from access-token
...
pub enum ChatgptAuthTokensRefreshReason {
    /// Forestx attempted a backend request and received `401 Unauthorized`.
    Unauthorized,
}
...
pub struct ChatgptAuthTokensRefreshParams {
    ...
    /// Workspace/account identifier that Forestx was previously using.
    ///
...
pub struct GetAccountRateLimitsResponse {
    ...
    /// Multi-bucket view keyed by metered `limit_id` (for example, `forestx`).
