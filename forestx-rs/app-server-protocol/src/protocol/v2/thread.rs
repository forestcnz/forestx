...
pub use forestx_protocol::capabilities::CapabilityRootLocation;
pub use forestx_protocol::capabilities::SelectedCapabilityRoot;
...
use forestx_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use forestx_protocol::protocol::TokenUsage as CoreTokenUsage;
use forestx_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "forestx_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
    ...
    /// This is for internal use only (e.g. Forestx Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR FORESTX CLOUD - DO NOT USE.
...
impl From<forestx_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: forestx_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> forestx_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => forestx_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => forestx_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `forestx_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
