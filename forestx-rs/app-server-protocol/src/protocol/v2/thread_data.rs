...
use forestx_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use forestx_protocol::protocol::ThreadHistoryMode as CoreThreadHistoryMode;
use forestx_protocol::protocol::ThreadSource as CoreThreadSource;
...
#[ts(export_to = "v2/")]
pub struct Thread {
    /// Identifier for this thread. Forestx-generated thread IDs are UUIDv7.
    pub id: String,
    ...
    /// Origin of the thread (CLI, VSCode, forestx exec, forestx app-server, etc.).
...
#[ts(export_to = "v2/")]
pub struct Turn {
    /// Identifier for this turn. Forestx-generated turn IDs are UUIDv7.
    pub id: String,
