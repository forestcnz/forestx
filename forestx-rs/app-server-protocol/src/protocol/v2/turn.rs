...
use forestx_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use forestx_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use forestx_protocol::user_input::ByteRange as CoreByteRange;
use forestx_protocol::user_input::TextElement as CoreTextElement;
...
pub struct TurnStartParams {
    ...
    /// Optional metadata to enrich Forestx's ResponsesAPI turn metadata.
    ///
    /// Entries are flattened into the JSON string sent as
    /// `client_metadata["x-forestx-turn-metadata"]` on ResponsesAPI HTTP and websocket requests.
    ///
