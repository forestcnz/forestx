...
use crate::TS;
use forestx_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use forestx_protocol::protocol::SkillInterface as CoreSkillInterface;
use forestx_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use forestx_protocol::protocol::SkillScope as CoreSkillScope;
use forestx_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
...
pub enum PluginAvailability {
    ...
    /// Forestx app-server exposes `"AVAILABLE"` in its API; the alias keeps
