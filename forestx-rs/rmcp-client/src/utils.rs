...
const MCP_USER_AGENT: &str = concat!("forestx-mcp-client/", env!("CARGO_PKG_VERSION"));
...
#[cfg(windows)]
pub(crate) const DEFAULT_ENV_VARS: &[&str] =
    forestx_protocol::shell_environment::WINDOWS_CORE_ENV_VARS;
...
mod tests {
    ...
    fn create_env_preserves_path_when_it_is_not_utf8() {
        ...
        let raw_path = std::ffi::OsStr::from_bytes(b"/tmp/forestx-\xFF/bin");
