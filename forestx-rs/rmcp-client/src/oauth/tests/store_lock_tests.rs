...
use crate::oauth::test_support::TempForestxHome;
use forestx_config::types::OAuthCredentialsStoreMode;

const STORE_LOCK_CONTENTION_EVENT_TARGET: &str = "forestx_rmcp_client::oauth::store_lock::contention";
...
const LOCK_HOLDER_READY_PATH_ENV: &str = "FORESTX_OAUTH_STORE_LOCK_CHILD_READY_PATH";
    ...
    T: Send + 'static,
{
    std::thread::scope(|scope| {
        let held_lock =
            OAuthStoreLock::acquire_in(forestx_home, store, Duration::from_millis(/*millis*/ 100))?;
