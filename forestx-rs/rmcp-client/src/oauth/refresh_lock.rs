...
const LOCK_CONTENTION_EVENT_TARGET: &str = "forestx_rmcp_client::oauth::refresh_lock::contention";
...
impl RefreshCredentialLock {
    pub(super) async fn acquire_for_server(server_name: &str, url: &str) -> Result<Self> {
        ...
        Self::acquire_in(&forestx_home, &store_key, REFRESH_LOCK_ACQUIRE_TIMEOUT)
            .await
    ...
    async fn acquire_in(
        ...
        // Scope coordination to FORESTX_HOME alongside File and Secrets state. Direct keyring
