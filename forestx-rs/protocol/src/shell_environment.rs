...
pub const FORESTX_THREAD_ID_ENV_VAR: &str = "FORESTX_THREAD_ID";
    ...
    I: IntoIterator<Item = (String, String)>,
{
    ...
    if let Some(thread_id) = thread_id {
        env_map.insert(FORESTX_THREAD_ID_ENV_VAR.to_string(), thread_id.to_string());
    }
...
mod windows_tests {
    ...
    fn core_inherit_preserves_windows_startup_vars_case_insensitively() {
        let vars = make_vars(&[
            ...
            ("AppData", "C:\\Users\\forestx\\AppData\\Roaming"),
        ...
        let expected = HashMap::from([
            ...
            (
                "AppData".to_string(),
                "C:\\Users\\forestx\\AppData\\Roaming".to_string(),
            ),
...
mod non_windows_tests {
    ...
    fn core_inherit_preserves_non_windows_core_vars_case_insensitively() {
        ...
        let expected = HashMap::from([
            ...
            ("home".to_string(), "/home/forestx".to_string()),
