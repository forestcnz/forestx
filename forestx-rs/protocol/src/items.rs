...
pub struct WebSearchItem {
    ...
    ///
    /// These stay as opaque JSON at the Forestx transport boundary so new result
    /// fields and result types can pass through without changing model-visible
    /// context or requiring a Forestx release.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[ts(optional)]
...
mod tests {
    ...
    fn plugin_relative_paths_use_safe_wire_shape() {
        ...
        for path in [
            "",
            "/home/user/.forestx/plugins/cache/sample/scripts/run.py",
            "C:/Users/user/.forestx/plugins/cache/sample/scripts/run.py",
            "scripts/C:/run.py",
