//! Shared model metadata types exchanged between Forestx services and clients.
//!
...
/// Metadata describing a Forestx-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the Forestx backend `/models` endpoint.
