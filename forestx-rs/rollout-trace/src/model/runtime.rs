...
/// Runtime operation requested by the model, a JS code cell, or Forestx itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_forestx_turn_id: Option<ForestxTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the Forestx tool boundary.
    ///
    ...
    /// they describe how Forestx executed the request, not what the caller sent.
