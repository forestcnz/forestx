...
/// Forestx conversation/session UUID.
...
/// Process/session ID returned by Forestx's terminal runtime.
...
/// Canonical reduced graph for one Forestx rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the Forestx rollout/session being observed. `trace_id`
    ...
    pub forestx_turns: BTreeMap<ForestxTurnId, ForestxTurn>,
