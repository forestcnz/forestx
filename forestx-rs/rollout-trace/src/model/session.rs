...
/// One Forestx thread/session participating in the rollout.
///
...
/// Provenance for a traced Forestx thread.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// One activation of the Forestx runtime for one thread.
///
/// A Forestx turn groups protocol/runtime work for one thread activation.
/// It is not a user/assistant message pair; conversation belongs in
/// `ConversationItem`.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct ForestxTurn {
