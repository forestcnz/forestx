//! Trace bundle format, writer, and reducer for Forestx rollouts.
//!
//! This crate owns the trace schema. Hot-path Forestx code should depend on the
...
/// Shared recorder context for inference attempts within one Forestx turn.
...
pub use thread::FORESTX_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical Forestx tool boundary.
...
/// Append-only writer used by hot-path Forestx instrumentation.
