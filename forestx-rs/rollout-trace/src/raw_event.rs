...
pub struct RawTraceEvent {
    ...
    pub forestx_turn_id: Option<ForestxTurnId>,
...
pub enum RawTraceEventPayload {
    ...
    InferenceCancelled {
        ...
        /// before Forestx stopped consuming the stream.
        upstream_request_id: Option<String>,
        /// Why Forestx stopped consuming the provider stream before a terminal response event.
        reason: String,
    ...
    ToolCallRuntimeStarted {
        tool_call_id: ToolCallId,
        /// Runtime/protocol observation for how Forestx began executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallRuntimeEnded {
        tool_call_id: ToolCallId,
        status: ExecutionStatus,
        /// Runtime/protocol observation for how Forestx finished executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallEnded {
        tool_call_id: ToolCallId,
    ...
    AgentResultObserved {
        ...
        child_forestx_turn_id: ForestxTurnId,
...
impl RawTraceEventPayload {
    ...
    pub(crate) fn raw_payload_refs(&self) -> Vec<&RawPayloadRef> {
        match self {
            ...
            | RawTraceEventPayload::ForestxTurnEnded { .. }
