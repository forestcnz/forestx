...
use anyhow::Result;
use anyhow::bail;
use forestx_protocol::protocol::CollabAgentInteractionBeginEvent;
use forestx_protocol::protocol::CollabAgentInteractionEndEvent;
use forestx_protocol::protocol::CollabAgentSpawnEndEvent;
use forestx_protocol::protocol::CollabCloseBeginEvent;
use forestx_protocol::protocol::CollabCloseEndEvent;
...
pub(in crate::reducer) struct ObservedAgentResultEdge {
    ...
    pub(in crate::reducer) child_forestx_turn_id: String,
...
impl TraceReducer {
    ...
    pub(in crate::reducer) fn queue_agent_result_interaction_edge(
        ...
        let source = if let Some(source_item_id) = self.latest_assistant_message_item_for_turn(
            ...
            &observed.child_forestx_turn_id,
        ) {
        ...
        self.rollout
            ...
            .filter(|item| {
                item.thread_id == thread_id
                    && item.forestx_turn_id.as_deref() == Some(forestx_turn_id)
