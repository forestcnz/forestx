pub(crate) const OTEL_TARGET_PREFIX: &str = "forestx_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "forestx_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "forestx_otel.trace_safe";
