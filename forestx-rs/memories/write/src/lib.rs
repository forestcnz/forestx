//! Write-path implementation for Forestx memories.
//!
...
mod guard_limits {
    pub(super) const FORESTX_LIMIT_ID: &str = "forestx";
}
...
mod stage_one {
    pub(super) const REASONING_EFFORT: forestx_protocol::openai_models::ReasoningEffort =
        forestx_protocol::openai_models::ReasoningEffort::Low;
...
mod stage_two {
    pub(super) const REASONING_EFFORT: forestx_protocol::openai_models::ReasoningEffort =
        forestx_protocol::openai_models::ReasoningEffort::Medium;
    pub(super) const JOB_LEASE_SECONDS: i64 = 3_600;
    pub(super) const JOB_RETRY_DELAY_SECONDS: i64 = 3_600;
...
pub fn memory_root(forestx_home: &AbsolutePathBuf) -> AbsolutePathBuf {
    forestx_home.join("memories")
}
