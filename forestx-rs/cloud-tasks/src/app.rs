...
pub struct EnvironmentRow {
    ...
    pub is_pinned: bool,
    pub repo_hints: Option<String>, // e.g., "openai/forestx"
}
...
use forestx_cloud_tasks_client::CloudBackend;
...
pub struct AttemptView {
    ...
    pub status: forestx_cloud_tasks_client::AttemptStatus,
...
pub enum AppEvent {
    ...
    DetailsMessagesLoaded {
        ...
        attempt_status: forestx_cloud_tasks_client::AttemptStatus,
    },
    DetailsFailed {
        id: TaskId,
        title: String,
    ...
    AttemptsLoaded {
        id: TaskId,
        attempts: Vec<forestx_cloud_tasks_client::TurnAttempt>,
    },
    /// Background completion of new task submission
    NewTaskSubmitted(Result<forestx_cloud_tasks_client::CreatedTask, String>),
    ...
    ApplyFinished {
        id: TaskId,
        result: std::result::Result<forestx_cloud_tasks_client::ApplyOutcome, String>,
    },
}
...
mod tests {
    use super::*;
    use chrono::Utc;
    use forestx_cloud_tasks_client::CloudBackendFuture;
    use forestx_cloud_tasks_client::CloudTaskError;
    ...
    impl FakeBackend {
        async fn list_tasks(
            ...
            limit: Option<i64>,
            cursor: Option<&str>,
        ) -> Result<forestx_cloud_tasks_client::TaskListPage, CloudTaskError> {
            ...
            for (i, t) in titles.into_iter().enumerate() {
                out.push(TaskSummary {
                    ...
                    title: t.to_string(),
                    status: forestx_cloud_tasks_client::TaskStatus::Ready,
                    updated_at: Utc::now(),
                    environment_id: env.map(str::to_string),
                    environment_label: None,
                    summary: forestx_cloud_tasks_client::DiffSummary::default(),
                    is_review: false,
            ...
            Ok(forestx_cloud_tasks_client::TaskListPage {
                tasks: limited,
        ...
        async fn get_task_text(
            &self,
            _id: TaskId,
        ) -> Result<forestx_cloud_tasks_client::TaskText, CloudTaskError> {
            Ok(forestx_cloud_tasks_client::TaskText {
                prompt: Some("Example prompt".to_string()),
                messages: Vec::new(),
                turn_id: Some("fake-turn".to_string()),
                sibling_turn_ids: Vec::new(),
                attempt_placement: Some(0),
                attempt_status: forestx_cloud_tasks_client::AttemptStatus::Completed,
            })
        }
    }

    impl forestx_cloud_tasks_client::CloudBackend for FakeBackend {
        fn list_tasks<'a>(
            &'a self,
            env: Option<&'a str>,
            limit: Option<i64>,
            cursor: Option<&'a str>,
        ) -> CloudBackendFuture<'a, forestx_cloud_tasks_client::TaskListPage> {
        ...
        fn get_task_diff(&self, _id: TaskId) -> CloudBackendFuture<'_, Option<String>> {
            Box::pin(async {
                Err(forestx_cloud_tasks_client::CloudTaskError::Unimplemented(
                    "not used in test",
                ))
            })
        }
        ...
        fn get_task_text(
            &self,
            id: TaskId,
        ) -> CloudBackendFuture<'_, forestx_cloud_tasks_client::TaskText> {
        ...
        fn list_sibling_attempts(
            ...
            _task: TaskId,
            _turn_id: String,
        ) -> CloudBackendFuture<'_, Vec<forestx_cloud_tasks_client::TurnAttempt>> {
        ...
        ) -> CloudBackendFuture<'_, forestx_cloud_tasks_client::ApplyOutcome> {
            Box::pin(async {
                Err(forestx_cloud_tasks_client::CloudTaskError::Unimplemented(
                    "not used in test",
                ))
        ...
        fn create_task<'a>(
            ...
            _qa_mode: bool,
            _best_of_n: usize,
        ) -> CloudBackendFuture<'a, forestx_cloud_tasks_client::CreatedTask> {
            Box::pin(async {
                Err(forestx_cloud_tasks_client::CloudTaskError::Unimplemented(
                    "not used in test",
                ))
