...
use forestx_file_system::find_nearest_native_ancestor_with_markers;
...
/// directory. If you need Forestx to work from such a checkout simply pass the
...
mod tests {
    ...
    async fn git_metadata_commands_do_not_inherit_stdin() {
        const CHILD_ENV: &str = "FORESTX_GIT_UTILS_STDIN_CHILD";
    ...
    fn canonicalize_git_remote_url_normalizes_github_variants() {
        for remote in [
            "git@github.com:OpenAI/Forestx.git",
            "ssh://git@github.com/openai/forestx.git",
            "ssh://git@github.com:22/OpenAI/Forestx.git",
            "https://github.com/openai/forestx.git",
            "https://github.com:443/openai/forestx.git",
            "https://token@github.com/openai/forestx/",
            "github.com/OpenAI/Forestx.git",
        ] {
            assert_eq!(
                canonicalize_git_remote_url(remote),
                Some("github.com/openai/forestx".to_string())
            );
        }
    }
