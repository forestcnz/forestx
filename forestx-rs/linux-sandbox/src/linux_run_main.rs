...
) -> ForestxResult<crate::bwrap::BwrapArgs> {
...
fn exit_with_bwrap_build_error(err: forestx_protocol::error::ForestxErr) -> ! {
...
fn apply_inner_command_argv0_for_launcher(
    ...
    if supports_argv0 {
        argv.splice(
            ...
            ["--argv0".to_string(), FORESTX_LINUX_SANDBOX_ARG0.to_string()],
        );
        return;
    }
...
fn preflight_proc_mount_support(network_mode: BwrapNetworkMode) -> ForestxResult<bool> {
