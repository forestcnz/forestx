...
/// Selects the MCP extensions Forestx supports from those declared by the app-server host.
///
/// App-server clients may declare unrelated extensions. Forestx retains only the
