...
use forestx_rmcp_client::StoredOAuthTokens;
use forestx_rmcp_client::stored_oauth_credentials;
...
pub(crate) struct McpServerConnectionIdentity {
    ...
    runtime_auth: Option<ForestxAuth>,
    runtime_auth_token: Option<String>,
    forestx_apps_cache_identity: Option<(PathBuf, ConnectorRuntimeContextKey)>,
...
impl McpServerConnectionIdentity {
    ...
    pub(crate) fn has_same_connection_config(&self, other: &Self) -> bool {
        let same_runtime_auth = match (&self.runtime_auth, &other.runtime_auth) {
            (Some(ForestxAuth::AgentIdentity(left)), Some(ForestxAuth::AgentIdentity(right))) => {
        ...
        self.transport == other.transport
            ...
            && self.forestx_apps_cache_identity == other.forestx_apps_cache_identity
