//! Forestx Apps support for the host-owned apps MCP server.
//!
...
use forestx_utils_plugins::mcp_connector::sanitize_name;
...
pub(crate) fn normalize_forestx_apps_tool_title(connector_name: Option<&str>, value: &str) -> String {
...
pub(crate) fn normalize_forestx_apps_callable_name(
    tool_name: &str,
...
pub(crate) fn normalize_forestx_apps_callable_namespace(
    server_name: &str,
    connector_name: Option<&str>,
) -> String {
    if let Some(connector_name) = connector_name {
