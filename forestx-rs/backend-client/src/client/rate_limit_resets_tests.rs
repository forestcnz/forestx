...
fn rate_limit_reset_contract_uses_expected_paths_and_payloads() {
    assert_eq!(
        test_client("https://example.test", PathStyle::ForestxApi).rate_limit_status_url(),
        "https://example.test/api/forestx/usage"
    );
    assert_eq!(
        test_client("https://example.test", PathStyle::ForestxApi).rate_limit_reset_credits_url(),
        "https://example.test/api/forestx/rate-limit-reset-credits"
    );
    assert_eq!(
        test_client("https://example.test", PathStyle::ForestxApi)
            .consume_rate_limit_reset_credit_url(),
        "https://example.test/api/forestx/rate-limit-reset-credits/consume"
    );
    assert_eq!(
        ...
        RateLimitResetCreditsDetails {
            credits: vec![
                RateLimitResetCreditDetails {
                    ...
                    reset_type: "forestx_rate_limits".to_string(),
