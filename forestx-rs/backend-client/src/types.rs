pub use forestx_backend_openapi_models::models::ConfigBundleResponse;
pub use forestx_backend_openapi_models::models::CreditStatusDetails;
pub use forestx_backend_openapi_models::models::DeliveredConfigToml;
pub use forestx_backend_openapi_models::models::DeliveredManagedLayers;
pub use forestx_backend_openapi_models::models::DeliveredRequirementsToml;
pub use forestx_backend_openapi_models::models::DeliveredTomlFragment;
pub use forestx_backend_openapi_models::models::PaginatedListTaskListItem;
pub use forestx_backend_openapi_models::models::PlanType;
pub use forestx_backend_openapi_models::models::RateLimitReachedKind;
pub use forestx_backend_openapi_models::models::RateLimitStatusDetails;
pub use forestx_backend_openapi_models::models::RateLimitStatusPayload;
pub use forestx_backend_openapi_models::models::RateLimitWindowSnapshot;
pub use forestx_backend_openapi_models::models::SpendControlLimitDetails;
pub use forestx_backend_openapi_models::models::TaskListItem;
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct ForestxWorkspaceMessagesResponse {
    #[serde(default)]
    pub messages: Vec<ForestxWorkspaceMessage>,
}

/// Authenticated Forestx user settings used by CLI runtime policy.
#[derive(Clone, Copy, Debug, Default, Deserialize, PartialEq, Eq)]
pub struct ForestxUserSettingsResponse {
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct ForestxWorkspaceMessage {
    pub message_id: String,
    pub message_type: ForestxWorkspaceMessageType,
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum ForestxWorkspaceMessageType {
    Headline,
    Announcement,
    #[serde(other)]
    Unknown,
...
Second line"
    ...
    fn workspace_messages_response_deserializes_messages() {
        let response: ForestxWorkspaceMessagesResponse = serde_json::from_value(serde_json::json!({
            "messages": [
                {
        ...
        assert_eq!(
            response,
            ForestxWorkspaceMessagesResponse {
                messages: vec![
                    ForestxWorkspaceMessage {
                        message_id: "headline-id".to_string(),
                        message_type: ForestxWorkspaceMessageType::Headline,
                    ...
                    ForestxWorkspaceMessage {
                        ...
                        message_type: ForestxWorkspaceMessageType::Announcement,
                    ...
                    ForestxWorkspaceMessage {
                        ...
                        message_type: ForestxWorkspaceMessageType::Unknown,
