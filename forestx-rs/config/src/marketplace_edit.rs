...
pub fn remove_user_marketplace(
    ...
    let outcome = remove_user_marketplace_config(forestx_home, marketplace_name)?;
...
mod tests {
    ...
    fn remove_user_marketplace_removes_requested_entry() {
        ...
        record_user_marketplace(forestx_home.path(), "debug", &update).unwrap();
        record_user_marketplace(forestx_home.path(), "other", &update).unwrap();

        let removed = remove_user_marketplace(forestx_home.path(), "debug").unwrap();
    ...
    fn remove_user_marketplace_config_reports_case_mismatch() {
        ...
        let outcome = remove_user_marketplace_config(forestx_home.path(), "Debug").unwrap();
