...
/// Provenance for one layer in the effective Forestx configuration.
...
pub enum ConfigLayerSource {
    ...
    /// Configuration loaded from a project's `.forestx` directory.
    Project { dot_forestx_folder: AbsolutePathBuf },
    ...
    match source {
        ...
        ConfigLayerSource::Project { dot_forestx_folder } => {
            format!(
                ...
                dot_forestx_folder.as_path().display()
            )
        }
