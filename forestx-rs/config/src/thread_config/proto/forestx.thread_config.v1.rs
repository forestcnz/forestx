        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::LoadThreadConfigResponse>, tonic::Status>
        {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/forestx.thread_config.v1.ThreadConfigLoader/Load",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "forestx.thread_config.v1.ThreadConfigLoader",
                "Load",
            ));
...
pub mod thread_config_loader_server {
    ...
    pub const SERVICE_NAME: &str = "forestx.thread_config.v1.ThreadConfigLoader";
