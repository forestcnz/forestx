use super::*;
use forestx_file_system::CopyOptions;
use forestx_file_system::CreateDirectoryOptions;
use forestx_file_system::ExecutorFileSystemFuture;
use forestx_file_system::FileMetadata;
use forestx_file_system::FileSystemReadStream;
use forestx_file_system::FileSystemSandboxContext;
use forestx_file_system::ReadDirectoryEntry;
use forestx_file_system::RemoveOptions;
...
async fn profile_v2_rejects_matching_legacy_profile_in_base_user_config() {
  ...
  "profiles": { "work": { "model": "gpt-work" } }
    ...
    assert!(
        message.contains("https://developers.openai.com/forestx/config-advanced#profiles"),
        "unexpected error message: {message}"
    );
}
