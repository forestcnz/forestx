...
- This repo’s scaffold writes `.forestx-plugin/plugin.json`; treat that as the manifest location this skill generates.
...
- `plugins` (`array`): Ordered plugin entries. This order determines how Forestx renders plugins.
