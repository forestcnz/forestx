...
def build_plugin_json(plugin_name: str, *, with_mcp: bool, with_apps: bool) -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        ...
        "interface": {
            ...
            "shortDescription": f"Use {display_name} in Forestx.",
            "longDescription": f"{display_name} adds a local Forestx plugin scaffold.",
...
def main() -> None:
    ...
    plugin_json_path = plugin_root / ".forestx-plugin" / "plugin.json"
    write_json(
        plugin_json_path,
