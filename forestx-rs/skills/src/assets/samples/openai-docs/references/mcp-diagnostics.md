...
3. When the current documentation supports it, the local Forestx CLI setup is:

   ```sh
   forestx mcp add openaiDeveloperDocs --url https://developers.openai.com/mcp
   ```
