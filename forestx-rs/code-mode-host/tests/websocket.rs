...
use anyhow::Context;
use anyhow::Result;
use forestx_code_mode::CellId;
use forestx_code_mode::CodeModeNestedToolCall;
use forestx_code_mode::CodeModeSessionDelegate;
use forestx_code_mode::CodeModeSessionProvider;
use forestx_code_mode::CodeModeToolKind;
use forestx_code_mode::ExecuteRequest;
use forestx_code_mode::FunctionCallOutputContentItem;
use forestx_code_mode::NoopCodeModeSessionDelegate;
use forestx_code_mode::NotificationFuture;
use forestx_code_mode::RuntimeResponse;
use forestx_code_mode::ToolDefinition;
use forestx_code_mode::ToolInvocationFuture;
use forestx_code_mode::WebSocketCodeModeSessionProvider;
use forestx_code_mode_protocol::host::Capability;
use forestx_code_mode_protocol::host::CapabilitySet;
use forestx_code_mode_protocol::host::ClientHello;
use forestx_code_mode_protocol::host::ClientToHost;
use forestx_code_mode_protocol::host::DUAL_WEBSOCKET_CAPABILITY;
use forestx_code_mode_protocol::host::DelegateRequest;
use forestx_code_mode_protocol::host::DelegateResponse;
use forestx_code_mode_protocol::host::EncodedFrame;
use forestx_code_mode_protocol::host::HostHello;
use forestx_code_mode_protocol::host::HostRequest;
use forestx_code_mode_protocol::host::HostResponse;
use forestx_code_mode_protocol::host::HostToClient;
use forestx_code_mode_protocol::host::MAX_FRAME_BYTES;
use forestx_code_mode_protocol::host::ProtocolVersion;
use forestx_code_mode_protocol::host::RequestId;
use forestx_code_mode_protocol::host::SessionId;
use forestx_code_mode_protocol::host::SupportedProtocolVersions;
use forestx_code_mode_protocol::host::WireContentItem;
use forestx_code_mode_protocol::host::WireExecuteRequest;
use forestx_code_mode_protocol::host::WireResult;
use forestx_code_mode_protocol::host::WireRuntimeResponse;
use forestx_code_mode_protocol::host::WireToolDefinition;
use forestx_code_mode_protocol::host::WireToolKind;
use forestx_code_mode_protocol::host::WireToolName;
use forestx_code_mode_protocol::host::WireWaitRequest;
...
impl HostHarness {
    async fn start() -> Result<Self> {
        let host_program = forestx_utils_cargo_bin::cargo_bin("forestx-code-mode-host")?;
...
async fn websocket_control_operations_bypass_an_incomplete_bulk_frame() -> Result<()> {
    ...
    let bulk_message = ClientToHost::DelegateResponse {
        id: forestx_code_mode_protocol::host::DelegateRequestId::new(/*value*/ 999),
        result: WireResult::Ok {
            value: DelegateResponse::ToolResult {
        ...
        .send(&ClientToHost::Request {
            ...
            request: HostRequest::Wait {
                ...
                request: WireWaitRequest {
                    cell_id: forestx_code_mode_protocol::host::WireCellId::new("missing-cell"),
                    yield_time_ms: 10,
                },
            },
        })
