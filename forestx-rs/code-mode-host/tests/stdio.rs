...
use forestx_code_mode::WaitOutcome;
use forestx_code_mode::WaitRequest;
use forestx_code_mode::host::MAX_FRAME_BYTES;
...
async fn remote_session_persists_values_forwards_delegates_and_controls_cells() {
    let provider = ProcessOwnedCodeModeSessionProvider::with_host_program(
        forestx_utils_cargo_bin::cargo_bin("forestx-code-mode-host").expect("host binary"),
    );
