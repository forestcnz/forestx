...
const TEST_BINARY_ENV_VAR: &str = "FORESTX_WINE_EXEC_TEST_BINARY";
const TEST_ENVIRONMENT_ENV_VAR: &str = "FORESTX_TEST_ENVIRONMENT";
const REMOTE_EXEC_SERVER_URL_ENV_VAR: &str = "FORESTX_TEST_REMOTE_EXEC_SERVER_URL";
const LEGACY_REMOTE_ENV_ENV_VAR: &str = "FORESTX_TEST_REMOTE_ENV";
const DOCKER_CONTAINER_ENV_VAR: &str = "FORESTX_TEST_REMOTE_ENV_CONTAINER_NAME";
