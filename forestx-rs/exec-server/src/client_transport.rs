...
const ENVIRONMENT_CLIENT_NAME: &str = "forestx-environment";
...
impl ExecServerClient {
    ...
    #[tracing::instrument(name = "forestx.exec_server.remote.noise.connect", skip_all)]
    ...
    #[tracing::instrument(
        name = "forestx.exec_server.remote.harness.connect",
        skip_all,
        fields(
            otel.kind = "client",
            otel.name = "forestx.exec_server.remote.harness.connect",
        )
    )]
    ...
    #[tracing::instrument(
        name = "forestx.exec_server.remote.noise.websocket_connect",
        skip_all,
        fields(
            otel.kind = "client",
            otel.name = "forestx.exec_server.remote.noise.websocket_connect",
