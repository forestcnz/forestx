...
use forestx_exec_server::FsCloseParams;
use forestx_exec_server::FsOpenParams;
use forestx_exec_server::FsReadBlockParams;
use forestx_exec_server::FsReadBlockResponse;
...
async fn file_reads_reject_named_pipes() -> Result<()> {
    ...
    let read_path = format!(r"\\.\pipe\forestx-fs-read-{}", Uuid::new_v4());
    ...
    let stream_path = format!(r"\\.\pipe\forestx-fs-stream-{}", Uuid::new_v4());
