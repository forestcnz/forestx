...
#[path = "../src/proto/forestx.exec_server.relay.v1.rs"]
mod relay_proto;
...
use forestx_exec_server::EnvironmentConnectionState;
use forestx_exec_server::EnvironmentManager;
use forestx_exec_server::EnvironmentReadyInfo;
use forestx_exec_server::ExecParams;
use forestx_exec_server::ExecResponse;
use forestx_exec_server::ExecServerClient;
use forestx_exec_server::ExecServerError;
use forestx_exec_server::ExecServerRuntimePaths;
use forestx_exec_server::FsReadFileParams;
use forestx_exec_server::NoiseChannelIdentity;
use forestx_exec_server::NoiseChannelPublicKey;
use forestx_exec_server::NoiseRendezvousConnectArgs;
use forestx_exec_server::NoiseRendezvousConnectBundle;
use forestx_exec_server::NoiseRendezvousConnectProvider;
use forestx_exec_server::ProcessId;
use forestx_exec_server::RemoteEnvironmentConfig;
use forestx_exec_server_protocol::ProcessSandboxType;
use forestx_http_client::HttpClientFactory;
use forestx_http_client::OutboundProxyPolicy;
use forestx_http_client::cache_system_proxy_route_for_test;
...
fn static_registry_auth_provider() -> forestx_api::SharedAuthProvider {
...
async fn deferred_noise_environment_connects_and_reconnects_with_fresh_bundle() -> Result<()> {
    ...
    let (forestx_exe, forestx_linux_sandbox_exe) = common::current_test_binary_helper_paths()?;
    let runtime_paths = ExecServerRuntimePaths::new(forestx_exe, forestx_linux_sandbox_exe)?;
    ...
    let remote_environment = tokio::spawn(forestx_exec_server::run_remote_environment(
        config,
        runtime_paths,
    ));
...
async fn remote_environment_routes_encrypted_exec_server_rpc() -> Result<()> {
    ...
    let client_args = NoiseRendezvousConnectArgs {
        ...
        http_client_factory: forestx_http_client::HttpClientFactory::new(
