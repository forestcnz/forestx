        ...
        tracing_subscriber::fmt::layer()
            ...
            .with_filter(
                tracing_subscriber::filter::Targets::new()
                    .with_target("forestx_http_client", tracing::Level::TRACE)
                    .with_target("forestx_exec_server", tracing::Level::TRACE),
            ),
    );
    let _guard = tracing::subscriber::set_default(subscriber);
    tracing::debug!(target: "forestx_exec_server", "log capture sentinel");
    let client =
