...
use forestx_exec_server::LocalFileSystem;
...
use crate::common::exec_server::TestForestxHelperPaths;
use crate::common::exec_server::exec_server;
use crate::common::exec_server::test_forestx_helper_paths;

pub(crate) struct FileSystemContext {
    pub(crate) file_system: Arc<dyn ExecutorFileSystem>,
    _helper_paths: Option<TestForestxHelperPaths>,
    ...
    match implementation {
        FileSystemImplementation::Local => {
            ...
            let runtime_paths = ExecServerRuntimePaths::new(
                helper_paths.forestx_exe.clone(),
                helper_paths.forestx_linux_sandbox_exe.clone(),
            )?;
