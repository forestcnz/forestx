use forestx_collaboration_mode_templates::DEFAULT as COLLABORATION_MODE_DEFAULT;
use forestx_collaboration_mode_templates::PLAN as COLLABORATION_MODE_PLAN;
use forestx_protocol::config_types::CollaborationModeMask;
use forestx_protocol::config_types::ModeKind;
use forestx_protocol::config_types::TUI_VISIBLE_COLLABORATION_MODES;
