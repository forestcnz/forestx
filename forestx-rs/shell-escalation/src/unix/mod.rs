...
//! `EscalateRequest` over the inherited `FORESTX_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `FORESTX_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use forestx_protocol::approvals::EscalationPermissions;
pub use forestx_protocol::approvals::ResolvedPermissionProfile;
