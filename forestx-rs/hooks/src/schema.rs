...
pub(crate) struct PreToolUseCommandInput {
    ...
    /// Forestx extension: expose the active turn id to internal turn-scoped hooks.
    pub turn_id: String,
...
mod tests {
    ...
    #[test]
    fn turn_scoped_hook_inputs_include_forestx_turn_id_extension() {
        // Forestx intentionally diverges from Claude's public hook docs here so
