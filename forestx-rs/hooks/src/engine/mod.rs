...
pub(crate) struct ConfiguredHandler {
    pub event_name: forestx_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            forestx_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            forestx_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            forestx_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            forestx_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            forestx_protocol::protocol::HookEventName::PostCompact => "post-compact",
            forestx_protocol::protocol::HookEventName::SessionStart => "session-start",
            forestx_protocol::protocol::HookEventName::SessionEnd => "session-end",
            forestx_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            forestx_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            forestx_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            forestx_protocol::protocol::HookEventName::Stop => "stop",
        }
    }
}
...
impl ClaudeHooksEngine {
    ...
    async fn maybe_spill_prompt_fragments(
        &self,
        session_id: ThreadId,
        fragments: Vec<forestx_protocol::items::HookPromptFragment>,
    ) -> Vec<forestx_protocol::items::HookPromptFragment> {
        self.output_spiller
