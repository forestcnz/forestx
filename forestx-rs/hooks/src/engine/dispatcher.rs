...
pub(crate) fn completed_summary(
    ...
    entries: Vec<forestx_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    HookRunSummary {
        id: handler.run_id(),
        event_name: handler.event_name,
...
pub(crate) fn hook_source_label(source: forestx_protocol::protocol::HookSource) -> &'static str {
    match source {
        forestx_protocol::protocol::HookSource::System => "system",
        forestx_protocol::protocol::HookSource::User => "user",
        forestx_protocol::protocol::HookSource::Project => "project",
        forestx_protocol::protocol::HookSource::Mdm => "mdm",
        forestx_protocol::protocol::HookSource::SessionFlags => "session_flags",
        forestx_protocol::protocol::HookSource::Plugin => "plugin",
        forestx_protocol::protocol::HookSource::CloudRequirements => "cloud_requirements",
        forestx_protocol::protocol::HookSource::CloudManagedConfig => "cloud_managed_config",
        forestx_protocol::protocol::HookSource::LegacyManagedConfigFile => {
            "legacy_managed_config_file"
        }
        forestx_protocol::protocol::HookSource::LegacyManagedConfigMdm => "legacy_managed_config_mdm",
        forestx_protocol::protocol::HookSource::Unknown => "unknown",
    }
}
