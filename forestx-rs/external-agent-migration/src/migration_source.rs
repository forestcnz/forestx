...
impl ExternalAgentSource {
    ...
    pub(super) fn recent_sessions(
        ...
        match self {
            Self::Cla => {
                detect_recent_cla_sessions_with_limits(external_agent_home, forestx_home, limits)
            }
            Self::Cur => {
                detect_recent_cur_sessions_with_limits(external_agent_home, forestx_home, limits)
            }
        }
    }
