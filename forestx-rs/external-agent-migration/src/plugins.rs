...
use forestx_core_plugins::PluginInstallError;
...
use forestx_core_plugins::marketplace_add::is_local_marketplace_source;
...
impl ExternalAgentConfigService {
    ...
    pub async fn import_plugins(
        ...
        let config = ConfigBuilder::default()
            ...
            .fallback_cwd(Some(
                cwd.map(Path::to_path_buf)
                    .unwrap_or_else(|| self.forestx_home.clone()),
            ))
            .build()
            .await
        ...
        let plugins_manager = PluginsManager::new(self.forestx_home.clone())
        ...
        for plugin_group in plugins {
                ...
                configured_marketplace_paths.get(&marketplace_name)
            {
                ...
                match add_marketplace(self.forestx_home.clone(), requirements.clone(), request).await
                {
