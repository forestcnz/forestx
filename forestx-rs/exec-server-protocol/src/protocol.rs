...
pub use forestx_file_system::WalkOptions;
pub use forestx_file_system::WalkOutcome;
...
use forestx_shell_command::shell_detect::DetectedShell;
...
impl EnvironmentInfo {
    ...
    pub fn local() -> Self {
        Self {
            shell: forestx_shell_command::shell_detect::default_user_shell().into(),
...
pub struct ExecParams {
    ...
    #[serde(default)]
    pub pipe_stdin: bool,
    /// Optional process-visible argv0 override. Values such as `forestx-linux-sandbox` are command
...
mod tests {
    ...
    use forestx_network_proxy::RemoteNetworkProxyLaunchConfig;
    use forestx_protocol::config_types::WindowsSandboxProxySettingsMode;
