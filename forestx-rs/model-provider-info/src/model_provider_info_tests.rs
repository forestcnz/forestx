...
#[test]
fn test_personal_access_token_uses_chatgpt_forestx_base_url() {
    ...
    assert_eq!(api_provider.base_url, CHATGPT_FORESTX_BASE_URL);
}

#[test]
fn test_header_auth_uses_chatgpt_forestx_base_url() {
    let api_provider = ModelProviderInfo::create_openai_provider(/*base_url*/ None)
