...
use forestx_code_mode_protocol::CodeModeSession;
use forestx_code_mode_protocol::CodeModeSessionDelegate;
use forestx_code_mode_protocol::CodeModeSessionResultFuture;
use forestx_code_mode_protocol::CodeModeToolKind;
use forestx_code_mode_protocol::DEFAULT_EXEC_YIELD_TIME_MS;
use forestx_code_mode_protocol::ExecuteRequest;
use forestx_code_mode_protocol::ExecuteToPendingOutcome;
use forestx_code_mode_protocol::FunctionCallOutputContentItem;
use forestx_code_mode_protocol::ImageDetail;
use forestx_code_mode_protocol::NoopCodeModeSessionDelegate;
...
use forestx_code_mode_protocol::WaitToPendingOutcome;
use forestx_code_mode_protocol::WaitToPendingRequest;
        ...
        self.delegate
            .invoke_tool(
                CodeModeNestedToolCall {
                    ...
                    tool_name: forestx_protocol::ToolName {
