    ...
    route_outgoing_envelope(
        ...
        OutgoingEnvelope::ToConnection {
            ...
            message: OutgoingMessage::Request(ServerRequest::CommandExecutionRequestApproval {
                ...
                params: forestx_app_server_protocol::CommandExecutionRequestApprovalParams {
                    ...
                    additional_permissions: Some(
                        forestx_app_server_protocol::AdditionalPermissionProfile {
                            network: None,
                            file_system: Some(
                                forestx_app_server_protocol::AdditionalFileSystemPermissions {
