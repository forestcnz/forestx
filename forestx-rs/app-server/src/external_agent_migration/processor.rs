...
use forestx_analytics::ExternalAgentConfigImportCompletedInput;
use forestx_analytics::ExternalAgentConfigImportFailureInput;
...
use forestx_app_server_protocol::ExternalAgentConfigImportHistoryRecordParams;
use forestx_app_server_protocol::ExternalAgentConfigImportHistoryRecordResponse;
use forestx_app_server_protocol::ExternalAgentConfigImportItemTypeFailure as ProtocolImportFailure;
use forestx_app_server_protocol::ExternalAgentConfigImportItemTypeSuccess as ProtocolImportSuccess;
...
use forestx_app_server_protocol::ExternalAgentConfigImportTypeResult as ProtocolImportTypeResult;
...
use forestx_external_agent_migration::DetectedConnectorCandidate;
use forestx_external_agent_migration::ExternalAgentConfigDetectOptions;
use forestx_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use forestx_external_agent_migration::ExternalAgentConfigImportOutcome as CoreImportOutcome;
use forestx_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use forestx_external_agent_migration::ExternalAgentConfigService;
use forestx_external_agent_migration::ExternalAgentSessionImportLimits;
use forestx_external_agent_migration::PluginImportOutcome;
use forestx_external_agent_migration::record_import_error;
use forestx_external_agent_migration::sessions::ExternalAgentSessionMigration as CoreSessionMigration;
use forestx_external_agent_migration::sessions::read_imported_connector_candidates;
use forestx_external_agent_migration::sessions::record_detected_session_connectors;
use forestx_features::Feature;
use forestx_rollout::StateDbHandle;
use forestx_state::ExternalAgentConfigImportFailureRecord;
use forestx_state::ExternalAgentConfigImportSuccessRecord;
...
pub(crate) struct ExternalAgentConfigRequestProcessorArgs {
    ...
    pub(crate) forestx_home: PathBuf,
}
...
impl ExternalAgentConfigRequestProcessor {
    ...
    pub(crate) async fn detect(
        ...
        record_detected_session_connectors(
            self.migration_service.forestx_home(),
    ...
    pub(crate) async fn read_import_histories(
        ...
        let connectors = read_imported_connector_candidates(self.migration_service.forestx_home())
            .map_err(|err| {
                internal_error(format!(
