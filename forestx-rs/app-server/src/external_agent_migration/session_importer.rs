...
use forestx_external_agent_migration::ExternalAgentConfigImportItemResult;
use forestx_external_agent_migration::record_import_error;
use forestx_external_agent_migration::sessions::CompletedExternalAgentSessionImport;
use forestx_external_agent_migration::sessions::ExistingSessionAppend;
use forestx_external_agent_migration::sessions::ExternalAgentSessionMigration;
use forestx_external_agent_migration::sessions::ImportedExternalAgentSession;
use forestx_external_agent_migration::sessions::ImportedSessionConnectorAttribution;
use forestx_external_agent_migration::sessions::PendingSessionImport;
use forestx_external_agent_migration::sessions::SessionImportTarget;
use forestx_external_agent_migration::sessions::SessionMetadataMode;
use forestx_external_agent_migration::sessions::append_existing_session;
use forestx_external_agent_migration::sessions::append_imported_session_connector_names;
use forestx_external_agent_migration::sessions::detect_imported_cla_session_connectors_by_source_path;
use forestx_external_agent_migration::sessions::prepare_validated_session_import_with_metadata_mode;
use forestx_external_agent_migration::sessions::record_completed_session_imports;
...
impl ExternalAgentSessionImporter {
    ...
    pub(super) async fn import_sessions(
        ...
        let completed_imports = completed_imports
            ...
            .collect();
        if let Err(err) = record_completed_session_imports(&self.forestx_home, completed_imports) {
            record_import_error(
                &mut item_result,
                "session_ledger_update",
    ...
    async fn prepare_session_import(
        ...
        tokio::task::spawn_blocking(move || {
            prepare_validated_session_import_with_metadata_mode(&forestx_home, session, metadata_mode)
        })
        .await
        .map_err(|err| {
    ...
    async fn persist_session(
        ...
        let create_params = CreateThreadParams {
            ...
            source: source.clone(),
            thread_source: None,
            originator: forestx_login::default_client::originator().value,
