...
use forestx_app_server_protocol::CommandMigration;
...
use forestx_app_server_protocol::ExternalAgentConfigImportHistory;
...
use forestx_app_server_protocol::ExternalAgentDetectedConnectorCandidate;
use forestx_app_server_protocol::ExternalAgentDetectedConnectorSource;
use forestx_app_server_protocol::HookMigration;
use forestx_app_server_protocol::JSONRPCErrorError;
use forestx_app_server_protocol::McpServerMigration;
use forestx_app_server_protocol::MigrationDetails;
use forestx_app_server_protocol::PluginsMigration;
use forestx_app_server_protocol::SkillMigration;
use forestx_app_server_protocol::SubagentMigration;
use forestx_external_agent_migration::DetectedConnectorCandidate as CoreDetectedConnectorCandidate;
use forestx_external_agent_migration::DetectedConnectorSource as CoreDetectedConnectorSource;
use forestx_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use forestx_external_agent_migration::ExternalAgentConfigImportRawError as CoreImportRawError;
use forestx_external_agent_migration::ExternalAgentConfigImportSuccess;
use forestx_external_agent_migration::ExternalAgentConfigMigrationItem as CoreMigrationItem;
use forestx_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use forestx_external_agent_migration::MigrationDetails as CoreMigrationDetails;
use forestx_external_agent_migration::NamedMigration;
use forestx_external_agent_migration::PluginsMigration as CorePluginsMigration;
use forestx_external_agent_migration::sessions::ExternalAgentSessionMigration;
...
fn protocol_migration_details(details: CoreMigrationDetails) -> MigrationDetails {
    MigrationDetails {
        ...
        sessions: details
            .sessions
            .into_iter()
            .map(|session| forestx_app_server_protocol::SessionMigration {
                path: session.path,
                cwd: session.cwd,
                title: session.title,
            })
...
pub(super) fn protocol_import_history(
    record: forestx_state::ExternalAgentConfigImportHistoryRecord,
