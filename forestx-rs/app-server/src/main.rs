use clap::Parser;
use forestx_app_server::AppServerCodeModeHostArgs;
use forestx_app_server::AppServerRuntimeOptions;
use forestx_app_server::AppServerTransport;
use forestx_app_server::AppServerWebsocketAuthArgs;
...
const MANAGED_CONFIG_PATH_ENV_VAR: &str = "FORESTX_APP_SERVER_MANAGED_CONFIG_PATH";
    ...
    arg0_dispatch_or_else(move |arg0_paths: Arg0DispatchPaths| async move {
        ...
        runtime_options.remote_control_startup_mode =
            match (remote_control, remote_control_disabled) {
                (true, _) => forestx_app_server::RemoteControlStartupMode::EnabledEphemeral,
                (false, true) => forestx_app_server::RemoteControlStartupMode::DisabledEphemeral,
                (false, false) => forestx_app_server::RemoteControlStartupMode::ResolvePersisted,
            };
