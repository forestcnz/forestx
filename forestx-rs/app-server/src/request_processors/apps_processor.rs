...
impl AppsRequestProcessor {
    ...
    async fn apps_list_task(
        ...
        let should_retry = result
            .as_ref()
            .is_ok_and(|(_, forestx_apps_ready)| !forestx_apps_ready);
        outgoing
        ...
        if should_retry && !retry_params.force_refetch {
            ...
            .await
            {
                warn!("failed to refresh app list after forestx-apps readiness retry: {err:?}");
            }
        }
    }
    ...
    async fn apps_list_response(
        ...
        let mut forestx_apps_ready = true;
        ...
        loop {
            ...
            match result {
                AppListLoadResult::Accessible(Ok(status)) => {
                    ...
                    forestx_apps_ready = status.forestx_apps_ready;
                }
            ...
            if accessible_loaded && all_loaded {
                ...
                return Ok((response, forestx_apps_ready));
            }
        }
    }
...
const APPS_INSTALLED_DURATION_METRIC: &str = "forestx.apps.installed.duration_ms";
