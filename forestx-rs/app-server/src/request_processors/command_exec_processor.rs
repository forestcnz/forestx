    ...
    async fn exec_one_off_command_inner(
        ...
        let (
            ...
            let file_system_sandbox_policy =
                forestx_protocol::permissions::FileSystemSandboxPolicy::from_legacy_sandbox_policy_for_cwd(&policy, &sandbox_cwd);
            let network_sandbox_policy =
                forestx_protocol::permissions::NetworkSandboxPolicy::from(&policy);
            let permission_profile =
                forestx_protocol::models::PermissionProfile::from_runtime_permissions_with_enforcement(
                    forestx_protocol::models::SandboxEnforcement::from_legacy_sandbox_policy(&policy),
        ...
        let forestx_linux_sandbox_exe = self.arg0_paths.forestx_linux_sandbox_exe.clone();
        ...
        let exec_request = forestx_core::exec::build_exec_request(
            exec_params,
            &effective_permission_profile,
            &sandbox_cwd,
