...
pub(super) async fn wait_for_thread_shutdown(thread: &Arc<ForestxThread>) -> ThreadShutdownResult {
...
fn merge_active_turn_into_page(
    page: &mut forestx_app_server_protocol::TurnsPage,
    mut active_turn: Turn,
    params: &forestx_app_server_protocol::ThreadResumeInitialTurnsPageParams,
) {
