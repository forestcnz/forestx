...
use forestx_login::default_client::SetOriginatorError;
...
const NON_ORIGINATING_CLIENT_NAMES: &[&str] = &["forestx_app_server_daemon", "forestx-backend"];
...
impl InitializeRequestProcessor {
    ...
    pub(crate) async fn initialize(
        ...
        let client_mcp_extensions = forestx_mcp::client_mcp_extensions(
            extensions,
            ...
            if let Err(error) = set_default_originator(originator.clone()) {
                match error {
                    ...
                    SetOriginatorError::AlreadyInitialized => {
                        ...
                        // TODO(owen): Once we remove support for FORESTX_INTERNAL_ORIGINATOR_OVERRIDE,
