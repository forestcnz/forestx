...
use forestx_app_server_protocol::PluginSearchResult;
use forestx_app_server_protocol::PluginSearchScope;
use forestx_core_plugins::OPENAI_BUNDLED_MARKETPLACE_NAME;
use forestx_core_plugins::remote::RemotePluginSearchRequest;
use forestx_core_plugins::remote::search_remote_plugins;
...
impl PluginRequestProcessor {
    ...
    async fn plugin_search_response(
        ...
        let use_remote_global_catalog =
            remote_plugin_enabled && auth_mode.is_some_and(DomainAuthMode::uses_forestx_backend);
        ...
        if auth_mode.is_some_and(DomainAuthMode::uses_forestx_backend)
