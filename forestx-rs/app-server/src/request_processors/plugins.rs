...
use forestx_analytics::PluginInstallSource;
use forestx_app_server_protocol::PluginAvailability;
use forestx_app_server_protocol::PluginInstallPolicy;
use forestx_app_server_protocol::PluginSharePrincipalRole;
use forestx_app_server_protocol::PluginShareTargetRole;
use forestx_config::types::McpServerConfig;
use forestx_core_plugins::OPENAI_CURATED_MARKETPLACE_NAME;
use forestx_core_plugins::PluginListBackgroundTaskOptions;
use forestx_core_plugins::is_openai_curated_marketplace_name;
use forestx_core_plugins::loader::load_configured_plugin_mcp_servers;
use forestx_core_plugins::manifest::is_agent_plugin_manifest;
use forestx_core_plugins::remote::REMOTE_CREATED_BY_ME_MARKETPLACE_NAME;
use forestx_core_plugins::remote::REMOTE_GLOBAL_MARKETPLACE_NAME;
use forestx_core_plugins::remote::REMOTE_WORKSPACE_MARKETPLACE_NAME;
use forestx_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_MARKETPLACE_NAME;
use forestx_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_PRIVATE_MARKETPLACE_NAME;
use forestx_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_UNLISTED_MARKETPLACE_NAME;
use forestx_core_plugins::remote::RemoteAppTemplateUnavailableReason;
use forestx_core_plugins::remote::RemotePluginCatalogCacheMode;
use forestx_core_plugins::remote::RemotePluginScope;
use forestx_core_plugins::remote::is_valid_remote_plugin_id;
use forestx_core_plugins::remote::validate_remote_plugin_id;
use forestx_core_plugins::remote_bundle::RemotePluginBundleInstallError;
use forestx_mcp::McpOAuthLoginSupport;
use forestx_mcp::McpRuntimeContext;
use forestx_mcp::oauth_login_support;
use forestx_mcp::should_retry_without_scopes;
use forestx_plugin::PluginId;
use forestx_plugin::PluginTelemetryMetadata;
use forestx_protocol::auth::AuthMode as DomainAuthMode;
use forestx_rmcp_client::OAuthDiscoveryTimeout;
use forestx_rmcp_client::StreamableHttpRedirectMode;
use forestx_rmcp_client::perform_oauth_login_silent;
...
pub(crate) struct PluginRequestProcessor {
    ...
    on_effective_plugins_changed:
        Arc<dyn Fn(forestx_core_plugins::EffectivePluginsChange) + Send + Sync>,
}

fn plugin_skills_to_info(
    skills: &[forestx_core::skills::SkillMetadata],
    ...
    skills
        ...
        .map(|skill| SkillSummary {
            ...
            interface: skill.interface.clone().map(|interface| {
                forestx_app_server_protocol::SkillInterface {
...
fn load_shared_plugin_ids_by_local_path(
    ...
    forestx_core_plugins::remote::load_plugin_share_remote_ids_by_local_path(
...
fn convert_configured_marketplace_plugin_to_plugin_summary(
    plugin: forestx_core_plugins::ConfiguredMarketplacePlugin,
    shared_plugin_ids_by_local_path: &std::collections::BTreeMap<AbsolutePathBuf, String>,
) -> PluginSummary {
...
) -> forestx_core_plugins::remote::RemotePluginShareDiscoverability {
    match discoverability {
        PluginShareDiscoverability::Listed => {
            forestx_core_plugins::remote::RemotePluginShareDiscoverability::Listed
        }
        PluginShareDiscoverability::Unlisted => {
            forestx_core_plugins::remote::RemotePluginShareDiscoverability::Unlisted
        }
        PluginShareDiscoverability::Private => {
            forestx_core_plugins::remote::RemotePluginShareDiscoverability::Private
        }
    }
}
...
) -> forestx_core_plugins::remote::RemotePluginShareUpdateDiscoverability {
    match discoverability {
        PluginShareUpdateDiscoverability::Listed => {
            forestx_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Listed
        }
        PluginShareUpdateDiscoverability::Unlisted => {
            forestx_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Unlisted
        }
        PluginShareUpdateDiscoverability::Private => {
            forestx_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Private
        }
    }
}
...
) -> forestx_core_plugins::remote::RemotePluginShareTargetRole {
    match role {
        PluginShareTargetRole::Reader => {
            forestx_core_plugins::remote::RemotePluginShareTargetRole::Reader
        }
        PluginShareTargetRole::Editor => {
            forestx_core_plugins::remote::RemotePluginShareTargetRole::Editor
        }
    }
}

fn plugin_share_principal_role_from_remote(
    role: forestx_core_plugins::remote::RemotePluginSharePrincipalRole,
) -> PluginSharePrincipalRole {
    match role {
        forestx_core_plugins::remote::RemotePluginSharePrincipalRole::Reader => {
            PluginSharePrincipalRole::Reader
        }
        forestx_core_plugins::remote::RemotePluginSharePrincipalRole::Editor => {
            PluginSharePrincipalRole::Editor
        }
        forestx_core_plugins::remote::RemotePluginSharePrincipalRole::Owner => {
...
) -> Vec<forestx_core_plugins::remote::RemotePluginShareTarget> {
    targets
        .into_iter()
        .map(
            |target| forestx_core_plugins::remote::RemotePluginShareTarget {
                principal_type: match target.principal_type {
                    PluginSharePrincipalType::User => {
                        forestx_core_plugins::remote::RemotePluginSharePrincipalType::User
                    }
                    PluginSharePrincipalType::Group => {
                        forestx_core_plugins::remote::RemotePluginSharePrincipalType::Group
                    }
                    PluginSharePrincipalType::Workspace => {
                        forestx_core_plugins::remote::RemotePluginSharePrincipalType::Workspace
                    }
                },
...
fn plugin_share_principal_from_remote(
    principal: forestx_core_plugins::remote::RemotePluginSharePrincipal,
...
impl PluginRequestProcessor {
    pub(crate) fn new(
        ...
        on_effective_plugins_changed: Arc<
            dyn Fn(forestx_core_plugins::EffectivePluginsChange) + Send + Sync,
        >,
    ) -> Self {
        Self {
            auth_manager,
    ...
    async fn workspace_forestx_plugins_enabled(
        &self,
        config: &Config,
        auth: Option<&ForestxAuth>,
    ) -> bool {
        match workspace_settings::forestx_plugins_enabled_for_workspace(
            config,
            auth,
        ...
        .await
        {
            ...
            Err(err) => {
                warn!(
                    "failed to fetch workspace Forestx plugins setting; allowing Forestx plugins: {err:#}"
                );
                true
            }
        }
    ...
    async fn plugin_list_response(
        ...
        if !self
            .workspace_forestx_plugins_enabled(&config, auth.as_ref())
            .await
        {
            return Ok(empty_response());
        }
        let auth_mode = auth.as_ref().map(ForestxAuth::api_auth_mode);
        ...
        let use_remote_global_catalog =
            include_global_remote && auth_mode.is_some_and(DomainAuthMode::uses_forestx_backend);
            ...
            match tokio::task::spawn_blocking(move || {
                ...
                Ok::<
                    (
                        ...
                        Vec<forestx_app_server_protocol::MarketplaceLoadErrorInfo>,
                    ),
                    MarketplaceError,
                >((
                    outcome
                    ...
                    outcome
                        .errors
                        .into_iter()
                        .map(|err| forestx_app_server_protocol::MarketplaceLoadErrorInfo {
        ...
        if include_vertical && !config.features.enabled(Feature::RemotePlugin) {
            match forestx_core_plugins::remote::fetch_openai_curated_remote_collection_marketplace(
        ...
        if !remote_sources.is_empty() {
            match forestx_core_plugins::remote::fetch_remote_marketplaces(
                &remote_plugin_service_config,
                auth.as_ref(),
                &remote_sources,
                /*catalog_cache_root*/ Some(config.forestx_home.as_path()),
    ...
    async fn plugin_installed_response(
        ...
        let use_remote_global_catalog = config.features.enabled(Feature::RemotePlugin)
            && auth_mode.is_some_and(DomainAuthMode::uses_forestx_backend);
    ...
    async fn load_local_installed_and_suggested_plugins(
        &self,
        plugins_manager: Arc<forestx_core_plugins::PluginsManager>,
        config: &Config,
        plugins_input: &forestx_core_plugins::PluginsConfigInput,
    ...
    async fn plugin_read_response(
        ...
        let plugins_input = config.plugins_config_input();
        let auth = self.auth_manager.auth().await;
        plugins_manager.set_auth_mode(auth.as_ref().map(ForestxAuth::api_auth_mode));
        ...
        let plugin = match read_source {
            Ok(marketplace_path) => {
                ...
                let share_context = match share_context {
                    Some(context) => {
                        let remote_plugin_service_config = remote_plugin_service_config(&config);
                        match forestx_core_plugins::remote::fetch_remote_plugin_share_context(
                            &remote_plugin_service_config,
                            auth.as_ref(),
                ...
                PluginDetail {
                    ...
                    hooks: outcome
                        ...
                        .hooks
                        .into_iter()
                        .map(|hook| forestx_app_server_protocol::PluginHookSummary {
                            key: hook.key,
            ...
            Err(remote_marketplace_name) => {
                ...
                let remote_detail = forestx_core_plugins::remote::fetch_remote_plugin_detail(
                    &remote_plugin_service_config,
                    auth.as_ref(),
                    &remote_marketplace_name,
                    &plugin_name,
                ...
                let plugin_apps = remote_detail
                    ...
                    .iter()
                    .cloned()
                    .map(forestx_plugin::AppConnectorId)
                    .collect::<Vec<_>>();
    ...
    async fn plugin_skill_read_response(
        ...
        let auth = self.auth_manager.auth().await;
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let remote_skill_detail = forestx_core_plugins::remote::fetch_remote_plugin_skill_detail(
            &remote_plugin_service_config,
            auth.as_ref(),
            &remote_marketplace_name,
            &remote_plugin_id,
    ...
    async fn plugin_share_save_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let access_policy = forestx_core_plugins::remote::RemotePluginShareAccessPolicy {
        ...
        let result = forestx_core_plugins::remote::save_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.forestx_home.as_path(),
            &plugin_path,
        ...
        forestx_core_plugins::remote::invalidate_cached_remote_plugin_catalog_scopes(
            config.forestx_home.as_path(),
            &remote_plugin_service_config,
            auth.as_ref(),
    ...
    async fn plugin_share_update_targets_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let result = forestx_core_plugins::remote::update_remote_plugin_share_targets(
            &remote_plugin_service_config,
            auth.as_ref(),
            &remote_plugin_id,
    ...
    async fn plugin_share_list_response(
        ...
        let (config, auth) = self.load_plugin_share_config_and_auth().await?;
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let data = forestx_core_plugins::remote::list_remote_plugin_shares(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.forestx_home.as_path(),
        )
    ...
    async fn plugin_share_checkout_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let result = forestx_core_plugins::remote::checkout_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.forestx_home.as_path(),
            &remote_plugin_id,
    ...
    async fn plugin_share_delete_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        forestx_core_plugins::remote::delete_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.forestx_home.as_path(),
            &remote_plugin_id,
    ...
    async fn load_plugin_share_config_and_auth(
        &self,
    ) -> Result<(Config, Option<ForestxAuth>), JSONRPCErrorError> {
        let config = self.load_latest_config(/*fallback_cwd*/ None).await?;
        if !config.features.enabled(Feature::Plugins) {
    ...
    async fn plugin_install_response(
        ...
        {
            return Err(invalid_request(
                "Forestx plugins are disabled for this workspace",
            ));
        }
        ...
        let plugin_mcp_servers = load_configured_plugin_mcp_servers(
            ...
            auth.as_ref().map(ForestxAuth::auth_mode),
            &result.plugin_id,
    ...
    async fn remote_plugin_install_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let remote_detail =
            forestx_core_plugins::remote::fetch_remote_plugin_detail_with_download_urls(
                &remote_plugin_service_config,
                auth.as_ref(),
                &remote_marketplace_name,
                &remote_plugin_id,
        ...
        let _remote_plugin_cache_mutation =
            forestx_core_plugins::remote::mark_remote_plugin_cache_mutation_in_flight(
                config.forestx_home.as_path(),
                &actual_remote_marketplace_name,
                &remote_plugin_name,
            );
        let validated_bundle = forestx_core_plugins::remote_bundle::validate_remote_plugin_bundle(
            &remote_plugin_id,
            &actual_remote_marketplace_name,
            &remote_plugin_name,
        ...
        let result = forestx_core_plugins::remote_bundle::download_and_install_remote_plugin_bundle(
            &remote_plugin_service_config,
        ...
        let install_result = forestx_core_plugins::remote::install_remote_plugin(
            &remote_plugin_service_config,
            auth.as_ref(),
            &actual_remote_marketplace_name,
            &remote_plugin_id,
        ...
        let is_chatgpt_auth = auth.as_ref().is_some_and(ForestxAuth::is_chatgpt_auth);
    ...
    async fn plugin_apps_needing_auth_for_install(
        ...
        auth: Option<&ForestxAuth>,
        plugin_id: &str,
        plugin_app_declarations: &[forestx_plugin::AppDeclaration],
    ) -> Vec<AppSummary> {
        if plugin_app_declarations.is_empty()
            || !config
                .features
                .apps_enabled_for_auth(auth.is_some_and(ForestxAuth::is_chatgpt_auth))
        {
            return Vec::new();
        }

        let plugin_apps =
            forestx_plugin::app_connector_ids_from_declarations(plugin_app_declarations);
        ...
        let (accessible_connectors, forestx_apps_ready) = match accessible_connectors_result {
            Ok(status) => (status.connectors, status.forestx_apps_ready),
            Err(err) => {
                warn!(
                    plugin = plugin_id,
        ...
        if !forestx_apps_ready {
            warn!(
                plugin = plugin_id,
                "forestx_apps MCP not ready after plugin install; skipping appsNeedingAuth check"
            );
            return Vec::new();
        }
    ...
    async fn plugin_uninstall_response(
        ...
        if forestx_plugin::PluginId::parse(&plugin_id).is_err()
    ...
    async fn remote_plugin_uninstall_response(
        ...
        let auth = self.auth_manager.auth().await;
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let uninstall_target = forestx_core_plugins::remote::resolve_remote_plugin_uninstall_target(
            &remote_plugin_service_config,
            auth.as_ref(),
            &plugin_id,
        )
        ...
        let uninstall_result = forestx_core_plugins::remote::uninstall_remote_plugin(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.forestx_home.to_path_buf(),
            uninstall_target,
...
async fn load_plugin_app_summaries(
    config: &Config,
    auth: Option<&ForestxAuth>,
    plugin_apps: &[forestx_plugin::AppConnectorId],
    ...
    if let Some(auth) = auth.filter(|auth| {
        config
            .features
            .apps_enabled_for_auth(auth.uses_forestx_backend())
    }) {
        metadata_by_id.extend(
            forestx_connectors::ConnectorMetadataStore::new(
                config.chatgpt_base_url.clone(),
                auth.get_account_id(),
    ...
    app_ids
        ...
        .map(|app_id| {
            ...
            AppSummary {
                install_url: Some(forestx_connectors::metadata::connector_install_url(
                    &name, &app_id,
                )),
                id: app_id,
                name,
...
fn plugin_app_category_by_id_from_value(value: &serde_json::Value) -> HashMap<String, String> {
    forestx_core_plugins::loader::plugin_app_declarations_from_value(value)
        .into_iter()
...
fn remote_plugin_share_discoverability_to_info(
    discoverability: forestx_core_plugins::remote::RemotePluginShareDiscoverability,
...
fn remote_plugin_bundle_install_error_to_jsonrpc(
    err: forestx_core_plugins::remote_bundle::RemotePluginBundleInstallError,
) -> JSONRPCErrorError {
