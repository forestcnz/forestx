...
use forestx_app_server_protocol::AccountRateLimitsUpdatedNotification;
use forestx_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use forestx_app_server_protocol::ForestxErrorInfo as V2ForestxErrorInfo;
use forestx_app_server_protocol::CommandAction as V2ParsedCommand;
use forestx_app_server_protocol::CommandExecutionApprovalDecision;
use forestx_app_server_protocol::CommandExecutionPresentation;
...
use forestx_app_server_protocol::DynamicToolCallParams;
use forestx_app_server_protocol::EnvironmentConnectionNotification;
use forestx_app_server_protocol::ErrorNotification;
use forestx_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use forestx_app_server_protocol::FileChangeApprovalDecision;
use forestx_app_server_protocol::FileChangeRequestApprovalParams;
use forestx_app_server_protocol::FileChangeRequestApprovalResponse;
use forestx_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use forestx_app_server_protocol::GuardianWarningNotification;
use forestx_app_server_protocol::HookCompletedNotification;
use forestx_app_server_protocol::HookStartedNotification;
use forestx_app_server_protocol::ItemCompletedNotification;
use forestx_app_server_protocol::ItemStartedNotification;
use forestx_app_server_protocol::McpServerElicitationAction;
use forestx_app_server_protocol::McpServerElicitationRequestParams;
use forestx_app_server_protocol::McpServerElicitationRequestResponse;
use forestx_app_server_protocol::McpServerStartupState;
use forestx_app_server_protocol::McpServerStatusUpdatedNotification;
use forestx_app_server_protocol::ModelReroutedNotification;
use forestx_app_server_protocol::ModelSafetyBufferingUpdatedNotification;
use forestx_app_server_protocol::ModelVerificationNotification;
use forestx_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use forestx_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use forestx_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use forestx_app_server_protocol::PermissionsRequestApprovalParams;
use forestx_app_server_protocol::PermissionsRequestApprovalResponse;
use forestx_app_server_protocol::RawResponseCompletedNotification;
use forestx_app_server_protocol::RawResponseItemCompletedNotification;
...
use forestx_app_server_protocol::ThreadRealtimeClosedNotification;
use forestx_app_server_protocol::ThreadRealtimeErrorNotification;
use forestx_app_server_protocol::ThreadRealtimeItemAddedNotification;
use forestx_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use forestx_app_server_protocol::ThreadRealtimeSdpNotification;
use forestx_app_server_protocol::ThreadRealtimeStartedNotification;
use forestx_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use forestx_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use forestx_app_server_protocol::ThreadRollbackResponse;
use forestx_app_server_protocol::ThreadSettingsUpdatedNotification;
use forestx_app_server_protocol::ThreadStatus;
use forestx_app_server_protocol::ThreadTokenUsage;
use forestx_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use forestx_app_server_protocol::ToolRequestUserInputOption;
use forestx_app_server_protocol::ToolRequestUserInputParams;
use forestx_app_server_protocol::ToolRequestUserInputQuestion;
use forestx_app_server_protocol::ToolRequestUserInputResponse;
...
use forestx_app_server_protocol::TurnModerationMetadataNotification;
...
use forestx_app_server_protocol::WarningNotification;
use forestx_app_server_protocol::build_item_from_guardian_event;
use forestx_app_server_protocol::guardian_auto_approval_review_notification;
use forestx_app_server_protocol::item_event_to_server_notification;
use forestx_core::ForestxThread;
use forestx_core::ThreadManager;
use forestx_protocol::ThreadId;
use forestx_protocol::items::CollabAgentTool as CoreCollabAgentTool;
use forestx_protocol::items::TurnItem as CoreTurnItem;
use forestx_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use forestx_protocol::plan_tool::UpdatePlanArgs;
use forestx_protocol::protocol::ForestxErrorInfo as CoreForestxErrorInfo;
use forestx_protocol::protocol::Event;
use forestx_protocol::protocol::EventMsg;
use forestx_protocol::protocol::ExecApprovalRequestEvent;
use forestx_protocol::protocol::Op;
use forestx_protocol::protocol::RealtimeEvent;
...
use forestx_protocol::protocol::TurnDiffEvent;
...
use forestx_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use forestx_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use forestx_sandboxing::policy_transforms::intersect_permission_profiles;
use forestx_shell_command::parse_command::shlex_join;
...
pub(crate) async fn apply_bespoke_event_handling(
    ...
    conversation: Arc<ForestxThread>,
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            let (status, error, failure_reason) = match update.status {
                forestx_protocol::protocol::McpStartupStatus::Starting => {
                    (McpServerStartupState::Starting, None, None)
                }
                forestx_protocol::protocol::McpStartupStatus::Ready => {
                    (McpServerStartupState::Ready, None, None)
                }
                forestx_protocol::protocol::McpStartupStatus::Failed { error, reason } => (
                    McpServerStartupState::Failed,
                    Some(error),
                    reason.map(Into::into),
                ),
                forestx_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            if assessment.status == forestx_protocol::protocol::GuardianAssessmentStatus::InProgress
            ...
            let completion_status = match assessment.status {
                forestx_protocol::protocol::GuardianAssessmentStatus::Denied
                | forestx_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                forestx_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                forestx_protocol::protocol::GuardianAssessmentStatus::InProgress
                | forestx_protocol::protocol::GuardianAssessmentStatus::Approved => None,
            };
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: forestx_protocol::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
        ...
        EventMsg::Error(ev) => {
            ...
            let forestx_error_info = ev.forestx_error_info.clone();
            ...
            if matches!(
                forestx_error_info,
                Some(CoreForestxErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                message: ev.message,
                forestx_error_info: ev.forestx_error_info.map(V2ForestxErrorInfo::from),
...
async fn maybe_emit_raw_response_item_completed(
    conversation_id: ThreadId,
    turn_id: &str,
    item: forestx_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
fn thread_rollback_response_from_stored_thread(
    stored_thread: forestx_thread_store::StoredThread,
    session_id: String,
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: forestx_protocol::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<ForestxThread>,
    thread_state: Arc<Mutex<ThreadState>>,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: forestx_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            forestx_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
mod tests {
    ...
    use anyhow::bail;
    use chrono::Utc;
    use forestx_app_server_protocol::AutoReviewDecisionSource;
    ...
    use forestx_protocol::items::AgentMessageContent as CoreAgentMessageContent;
    use forestx_protocol::items::AgentMessageItem as CoreAgentMessageItem;
    use forestx_protocol::items::DynamicToolCallItem;
    use forestx_protocol::items::DynamicToolCallStatus as CoreDynamicToolCallStatus;
    use forestx_protocol::items::SubAgentActivityItem;
    use forestx_protocol::items::TurnItem as CoreTurnItem;
    use forestx_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    ...
    use forestx_protocol::plan_tool::PlanItemArg;
    use forestx_protocol::plan_tool::StepStatus;
    use forestx_protocol::protocol::AgentMessageEvent;
    use forestx_protocol::protocol::AskForApproval;
    use forestx_protocol::protocol::CreditsSnapshot;
    use forestx_protocol::protocol::EventMsg;
    use forestx_protocol::protocol::GuardianAssessmentEvent;
    use forestx_protocol::protocol::GuardianAssessmentStatus;
    use forestx_protocol::protocol::ItemCompletedEvent;
    use forestx_protocol::protocol::ItemStartedEvent;
    ...
    use forestx_thread_store::StoredThreadHistory;
    use forestx_utils_absolute_path::AbsolutePathBuf;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            started_at: None,
            reason: forestx_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(forestx_protocol::protocol::GuardianRiskLevel::Low),
                Some(forestx_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(forestx_protocol::protocol::GuardianRiskLevel::High),
                Some(forestx_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(forestx_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = forestx_protocol::protocol::GuardianAssessmentAction::Command {
            source: forestx_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: forestx_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: forestx_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(forestx_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(forestx_protocol::protocol::GuardianUserAuthorization::Low),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    forestx_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(forestx_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(forestx_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = forestx_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: forestx_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: forestx_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn command_execution_started_helper_emits_once() -> Result<()> {
        ...
        let outgoing = Arc::new(OutgoingMessageSender::new(
            tx,
            forestx_analytics::AnalyticsEventsClient::disabled(),
        ));
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let config = load_default_config_for_test(&forestx_home).await;
        let thread_manager = Arc::new(
            forestx_core::test_support::thread_manager_with_models_provider_and_home(
                ForestxAuth::create_dummy_chatgpt_auth_for_testing(),
                config.model_provider.clone(),
                config.forestx_home.to_path_buf(),
                Arc::new(forestx_exec_server::EnvironmentManager::default_for_tests()),
            ),
        );
        let forestx_core::NewThread {
            thread_id: conversation_id,
            thread: conversation,
            ..
        } = thread_manager
            .start_thread(forestx_core::StartThreadOptions::new(config.clone()))
            .await?;
        let thread_state = new_thread_state();
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                forestx_error_info: Some(V2ForestxErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(forestx_protocol::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(forestx_protocol::protocol::UserMessageEvent {
                    client_id: None,
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(forestx_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    trace_id: None,
                    started_at: Some(42),
                    model_context_window: None,
    ...
    async fn interrupted_subagent_activity_removes_missing_thread_watch() -> Result<()> {
        ...
        let forestx_core::NewThread {
            ...
            .start_thread(forestx_core::StartThreadOptions::new(config))
            .await?;
        ...
        assert_eq!(
            ...
            ItemCompletedNotification {
                item: ThreadItem::SubAgentActivity {
                    id: "activity-1".to_string(),
                    kind: forestx_app_server_protocol::SubAgentActivityKind::Interrupted,
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                forestx_error_info: Some(V2ForestxErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_token_count_event_emits_usage_and_rate_limits() -> Result<()> {
        ...
        match second {
            ServerNotification::AccountRateLimitsUpdated(payload) => {
                assert_eq!(payload.rate_limits.limit_id.as_deref(), Some("forestx"));
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                forestx_error_info: Some(V2ForestxErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
