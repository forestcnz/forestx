use forestx_app_server_protocol::AppBranding as ApiAppBranding;
use forestx_app_server_protocol::AppInfo as ApiAppInfo;
use forestx_app_server_protocol::AppMetadata as ApiAppMetadata;
use forestx_app_server_protocol::AppReview as ApiAppReview;
use forestx_app_server_protocol::AppScreenshot as ApiAppScreenshot;
use forestx_app_server_protocol::AppToolSummary as ApiAppToolSummary;
use forestx_app_server_protocol::ConnectorMetadata as ApiConnectorMetadata;
use forestx_connectors::AppBranding;
use forestx_connectors::AppInfo;
use forestx_connectors::AppMetadata;
use forestx_connectors::AppReview;
use forestx_connectors::AppScreenshot;
...
/// Converts connector-domain app metadata owned by `forestx-connectors` into the app-server wire
/// type owned by `forestx-app-server-protocol`.
///
