...
use forestx_file_watcher::WatchRegistration;
...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: forestx_app_server_protocol::Thread,
    ...
    pub(crate) initial_turns_page:
        Option<forestx_app_server_protocol::ThreadResumeInitialTurnsPageParams>,
    pub(crate) paginated_turns: Option<Vec<Turn>>,
    pub(crate) paginated_initial_turns_page: Option<forestx_app_server_protocol::TurnsPage>,
    pub(crate) paginated_initial_turns_page_with_active_slot:
        Option<forestx_app_server_protocol::TurnsPage>,
    pub(crate) resume_cursor_store: Option<Arc<dyn forestx_thread_store::ThreadStore>>,
...
pub(crate) struct ThreadState {
    ...
    listener_thread: Option<Weak<ForestxThread>>,
    watch_registration: WatchRegistration,
}

impl ThreadState {
    pub(crate) fn listener_matches(&self, conversation: &Arc<ForestxThread>) -> bool {
