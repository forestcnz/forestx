...
use forestx_app_server_protocol::ExperimentalFeature;
...
use forestx_app_server_protocol::ExperimentalFeatureStage;
...
-> Result<()> {
    let forestx_home = TempDir::new()?;
    let project_cwd = forestx_home.path().join("project");
