...
const COMMIT_ATTRIBUTION: &str = "Co-authored-by: Forestx <noreply@openai.com>";
const PR_ATTRIBUTION: &str = "Generated with [Forestx](https://openai.com/forestx/).";
...
async fn git_attribution_follows_authenticated_workspace_policy() -> Result<()> {
    ...
    let mut app_server = TestAppServer::builder()
        ...
        .with_env_overrides(&[("OPENAI_API_KEY", None), ("FORESTX_ACCESS_TOKEN", None)])
        .build()
        .await?;
                        ...
                        && text.contains("<git_attribution>")
                    {
                        *text = match legacy_attribution {
                            ...
                            LegacyAttribution::UnlinkedPullRequest => {
                                text.replace(PR_ATTRIBUTION, "Generated with Forestx.")
                            }
                        };
                        replaced = true;
                    }
