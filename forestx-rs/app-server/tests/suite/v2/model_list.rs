...
use forestx_app_server_protocol::Model;
use forestx_app_server_protocol::ModelListParams;
use forestx_app_server_protocol::ModelListResponse;
use forestx_app_server_protocol::ModelServiceTier;
use forestx_app_server_protocol::ModelUpgradeInfo;
use forestx_app_server_protocol::ReasoningEffortOption;
...
fn expected_visible_models() -> Vec<Model> {
    ...
    let mut presets = ModelPreset::filter_by_auth(
        forestx_core::test_support::all_model_presets().clone(),
        /*chatgpt_mode*/ false,
    );
