...
use forestx_app_server_protocol::FuzzyFileSearchSessionCompletedNotification;
use forestx_app_server_protocol::FuzzyFileSearchSessionUpdatedNotification;
...
async fn test_fuzzy_file_search_sorts_and_includes_indices() -> Result<()> {
    // Prepare a temporary Forestx home and a separate root with test files.
