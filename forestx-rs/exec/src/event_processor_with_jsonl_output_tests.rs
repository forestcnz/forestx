...
fn failed_turn_does_not_overwrite_output_last_message_file() {
    ...
    let status = processor.process_server_notification(ServerNotification::TurnCompleted(
        forestx_app_server_protocol::TurnCompletedNotification {
            ...
            turn: forestx_app_server_protocol::Turn {
                ...
                error: Some(forestx_app_server_protocol::TurnError {
    ...
    assert_eq!(status, ForestxStatus::InitiateShutdown);
    ...
    let collected = processor.collect_thread_events(ServerNotification::ItemCompleted(
        forestx_app_server_protocol::ItemCompletedNotification {
            item: ThreadItem::McpToolCall {
                ...
                arguments: json!({"search_query": [{"q": "OpenAI Forestx CLI documentation"}]}),
                app_context: None,
