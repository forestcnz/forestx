...
const SETUP_BIN: &str = "forestx-windows-sandbox-setup";
const SETUP_MANIFEST: &str = "forestx-windows-sandbox-setup.manifest";
...
fn main() -> Result<(), String> {
    ...
    // Keep this scoped to the setup helper so Forestx binaries that link the
