...
fn retry_uses_original_unified_exec_request_and_stops_after_second_failure() {
    ...
    let request = RunnerTransportRequest {
        ...
        forestx_home: PathBuf::from(r"C:\Users\forestx"),
        cwd: PathBuf::from(r"C:\workspace"),
        env_map: env_map.clone(),
        logs_base_dir: Some(PathBuf::from(r"C:\Users\forestx\.sandbox")),
        spawn_request: SpawnRequest {
            ...
            forestx_home: PathBuf::from(r"C:\Users\forestx\.sandbox"),
            real_forestx_home: PathBuf::from(r"C:\Users\forestx"),
        ...
        deny_write_paths_override: vec![PathBuf::from(r"C:\workspace\.forestx")],
        proxy_enforced: true,
    ...
    let expected_refresh = RefreshObservation {
        ...
        env_map,
        forestx_home: request.forestx_home.clone(),
    ...
    let result = spawn_runner_transport_with_retry(
        ...
        &request,
        |forestx_home, cwd, sandbox_creds, logs_base_dir, spawn_request| {
