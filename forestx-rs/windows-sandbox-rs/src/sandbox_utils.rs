...
//! forestx home directory creation and git safe.directory injection so sandboxed
...
/// Ensure the sandbox forestx home directory exists.
pub fn ensure_forestx_home_exists(p: &Path) -> Result<()> {
...
mod tests {
    ...
    fn injects_worktree_root_for_gitfile() {
        ...
        fs::write(
            repo.join(".git"),
            "gitdir: C:/Users/example/repo/.git/worktrees/forestx3\n",
        )
