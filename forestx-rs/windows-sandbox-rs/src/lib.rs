...
pub use forestx_protocol::config_types::WindowsSandboxProxySettingsMode;
...
#[cfg(target_os = "windows")]
pub use logging::current_log_file_path_for_forestx_home;
#[cfg(target_os = "windows")]
...
#[cfg(target_os = "windows")]
pub use wrapper::FORESTX_WINDOWS_SANDBOX_ARG1;
#[cfg(target_os = "windows")]
...
mod windows_impl {
    ...
    use super::sandbox_utils::ensure_forestx_home_exists;
    ...
    pub fn run_windows_sandbox_capture_with_filesystem_overrides(
        ...
        let capability_roots =
            legacy_session_capability_roots(&permissions, &current_dir, &env_map, forestx_home);
