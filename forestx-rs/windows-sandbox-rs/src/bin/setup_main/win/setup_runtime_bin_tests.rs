...
fn runtime_paths_include_desktop_and_primary_runtime_roots() {
    ...
    assert_eq!(
        ...
        vec![
            PathBuf::from(r"C:\Users\user\AppData\Local\OpenAI\Forestx\bin"),
            PathBuf::from(r"C:\Users\user\AppData\Local\OpenAI\Forestx\runtimes"),
            PathBuf::from(r"C:\Users\user\.cache\forestx-runtimes"),
        ]
    );
}
...
fn primary_runtime_path_does_not_depend_on_local_app_data() {
    ...
    assert_eq!(
        ...
        vec![PathBuf::from(r"C:\Users\user\.cache\forestx-runtimes")]
    );
}
