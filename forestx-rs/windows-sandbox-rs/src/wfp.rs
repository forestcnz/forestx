...
const SESSION_NAME: &str = "Forestx Windows Sandbox WFP";
const PROVIDER_NAME: &str = "Forestx Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Forestx Windows sandbox filters";
const SUBLAYER_NAME: &str = "Forestx Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Forestx Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are Forestx-owned identities; do not regenerate them unless we
...
/// Installs the persistent Forestx WFP filters for `account`.
///
...
/// Ensures the persistent Forestx WFP provider exists.
...
/// Ensures the persistent Forestx sublayer exists under the Forestx provider.
