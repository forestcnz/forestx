...
pub(super) const FILTER_SPECS: &[FilterSpec] = &[
    FilterSpec {
        ...
        name: "forestx_wfp_icmp_connect_v4",
    ...
    FilterSpec {
        ...
        name: "forestx_wfp_icmp_connect_v6",
    ...
    FilterSpec {
        ...
        name: "forestx_wfp_icmp_assign_v4",
    ...
    FilterSpec {
        ...
        name: "forestx_wfp_icmp_assign_v6",
