...
use forestx_protocol::protocol::ThreadMemoryMode as MemoryMode;
...
pub struct CreateThreadParams {
    ...
    /// Thread id generated by Forestx before opening persistence.
...
pub struct StoredTurnError {
    ...
    pub message: String,
    /// Structured Forestx error classification, when available.
...
mod tests {
    ...
    fn session_meta(history_mode: ThreadHistoryMode) -> RolloutItem {
        RolloutItem::SessionMeta(forestx_protocol::protocol::SessionMetaLine {
