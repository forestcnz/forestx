...
//!
//! Application code should treat [`forestx_protocol::ThreadId`] as the only durable thread handle.
...
pub use forestx_state::MAX_QUEUE_ITEMS;
pub use forestx_state::QueuedUserSubmissionRecord;
