...
use forestx_rollout::first_rollout_content_match_snippet;
use forestx_rollout::parse_cursor;
use forestx_rollout::search_rollout_matches;
...
struct ThreadSearchItem {
    item: forestx_rollout::ThreadItem,
    snippet: String,
}
...
pub(super) async fn search_threads(
    ...
    loop {
        ...
        for item in page.items {
            let logical_path = forestx_rollout::plain_rollout_path(item.path.as_path());
