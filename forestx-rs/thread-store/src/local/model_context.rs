...
use forestx_rollout::ModelContextScan;
use forestx_rollout::ModelContextScanProgress;
use forestx_rollout::ReverseJsonlScanner;
use forestx_rollout::ScanOutcome;
...
pub(super) async fn load_for_fork(
    ...
    let session_meta = forestx_rollout::read_session_meta_line(source_path)
        .await
        .map_err(|err| ThreadStoreError::Internal {
            message: format!(
