...
use chrono::DateTime;
use forestx_app_server_protocol::ThreadHistoryChangeSet;
use forestx_app_server_protocol::project_rollout_line;
...
pub(super) async fn materialize_to_sqlite(
    ...
    let session_meta = forestx_rollout::read_session_meta_line(rollout_path)
        .await
        .map_err(thread_store_io_error)?
        .meta;
