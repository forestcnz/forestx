# forestx-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and Forestx did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust Forestx on it. Feel free to update the documentation as you
modify the code
...
```rust
use forestx_utils_stream_parser::CitationStreamParser;
use forestx_utils_stream_parser::StreamTextParser;
...
```rust
use forestx_utils_stream_parser::CitationStreamParser;
use forestx_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), forestx_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use forestx_utils_stream_parser::InlineHiddenTagParser;
use forestx_utils_stream_parser::InlineTagSpec;
use forestx_utils_stream_parser::StreamTextParser;
