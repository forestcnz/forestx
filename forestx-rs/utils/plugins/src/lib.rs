//! Plugin path resolution, plaintext mention sigils, and MCP connector helpers shared across Forestx
//! crates.
...
pub use forestx_exec_server_protocol::DISCOVERABLE_PLUGIN_MANIFEST_PATHS;
