//! Helpers for truncating tool and exec output using [`TruncationPolicy`](forestx_protocol::protocol::TruncationPolicy).

use forestx_protocol::models::FunctionCallOutputContentItem;
pub use forestx_utils_string::approx_bytes_for_tokens;
pub use forestx_utils_string::approx_token_count;
pub use forestx_utils_string::approx_tokens_from_byte_count;
use forestx_utils_string::truncate_middle_chars;
use forestx_utils_string::truncate_middle_with_token_budget;

pub use forestx_protocol::protocol::TruncationPolicy;
