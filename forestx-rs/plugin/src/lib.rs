...
pub use forestx_utils_plugins::mention_syntax;
pub use forestx_utils_plugins::plugin_namespace_for_skill_path;
...
pub struct PluginTelemetryMetadata {
    /// Local plugin identifier used by Forestx configuration and the plugin cache,
