...
use forestx_network_proxy::NetworkPolicyRequest;
use forestx_network_proxy::NetworkProtocol;
...
use forestx_windows_sandbox::create_process_as_user;
...
const CHILD_MODE_ENV: &str = "FORESTX_WINDOWS_PROXY_TEST_CHILD";
const HTTP_ADDR_ENV: &str = "FORESTX_WINDOWS_PROXY_TEST_HTTP_ADDR";
const SOCKS_ADDR_ENV: &str = "FORESTX_WINDOWS_PROXY_TEST_SOCKS_ADDR";
const ORIGIN_PORT_ENV: &str = "FORESTX_WINDOWS_PROXY_TEST_ORIGIN_PORT";
const ALLOWED_HOST_ENV: &str = "FORESTX_WINDOWS_PROXY_TEST_ALLOWED_HOST";
const DENIED_HOST_ENV: &str = "FORESTX_WINDOWS_PROXY_TEST_DENIED_HOST";
