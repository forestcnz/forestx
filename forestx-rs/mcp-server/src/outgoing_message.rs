...
impl OutgoingMessageSender {
    ...
    pub(crate) fn send_event_as_notification(
        ...
        self.send_notification(OutgoingNotification {
            method: "forestx/event".to_string(),
            params: Some(params),
        });
    }
...
// Additional mcp-specific data to be added to a [`forestx_protocol::protocol::Event`] as notification.params._meta
    ...
    async fn test_send_event_as_notification() -> Result<()> {
        ...
        let event = Event {
            ...
            msg: EventMsg::SessionConfigured(SessionConfiguredEvent {
                session_id: forestx_protocol::SessionId::new(),
                thread_id,
                forked_from_id: None,
        ...
        assert_eq!(method, "forestx/event");
