...
mod forestx_tool_config;
mod forestx_tool_runner;
mod exec_approval;
...
pub use crate::forestx_tool_config::ForestxToolCallParam;
pub use crate::forestx_tool_config::ForestxToolCallReplyParam;
...
const OTEL_SERVICE_NAME: &str = "forestx_mcp_server";
...
mod tests {
    ...
    async fn mcp_server_builds_otel_provider_with_logs_traces_and_metrics() -> anyhow::Result<()> {
        ...
        let provider = forestx_core::otel_init::build_provider(
            &config,
            "0.0.0-test",
            Some(OTEL_SERVICE_NAME),
            DEFAULT_ANALYTICS_ENABLED,
