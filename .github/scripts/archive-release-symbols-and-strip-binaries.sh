...
symbols_root="${RUNNER_TEMP:-/tmp}/forestx-symbols-${artifact_name}"
symbols_dir="${symbols_root}/forestx-symbols-${artifact_name}"
archive_path="${archive_dir%/}/forestx-symbols-${artifact_name}.tar.gz"
rm -rf "$symbols_root"
...
rm -f "$archive_path"
tar -C "$symbols_root" -czf "$archive_path" "forestx-symbols-${artifact_name}"
