...
if defined FORESTX_BAZEL_TEST_SKIP_FILTERS (
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$skipFilters = @();" ^
  "if (-not [string]::IsNullOrEmpty($env:FORESTX_BAZEL_TEST_SKIP_FILTERS)) { $skipFilters = @($env:FORESTX_BAZEL_TEST_SKIP_FILTERS -split ',' | Where-Object { $_ -ne '' }) };" ^
