...
# `*-unit-tests-bin` rust_test targets generated by `forestx_rust_crate()`.
...
manual_rust_test_targets="$(
  ./.github/scripts/run-bazel-query-ci.sh \
    --output=label \
    -- 'kind("rust_test rule", attr(tags, "manual", //forestx-rs/...))'
)"
...
excluded_targets="$(
  ./.github/scripts/run-bazel-query-ci.sh \
    --output=label \
    -- 'attr(tags, "no-argument-comment-lint", //forestx-rs/...)'
)"
