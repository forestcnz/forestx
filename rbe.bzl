...
platform(
    ...
    exec_properties = {{
        ...
        # Verify at https://hub.docker.com/layers/mbolin491/forestx-bazel/latest/images/sha256:{image_sha}
        "container-image": "docker://docker.io/mbolin491/forestx-bazel@sha256:{image_sha}",
        "Arch": "{arch}",
        "OSFamily": "Linux",
    }},
