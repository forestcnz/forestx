...
#   filename:  forestx_app_server_protocol.v2.schemas.json
...
class ForestxAppServerProtocolV2(BaseModel):
    pass
...
class AmazonBedrockCredentialSource(Enum):
    forestx_managed = "forestxManaged"
...
class ForestxErrorInfoValue(Enum):
...
class HttpConnectionFailedForestxErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamConnectionFailedForestxErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamDisconnectedForestxErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseTooManyFailedAttemptsForestxErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ProjectConfigLayerSource(BaseModel):
    ...
    dot_forestx_folder: Annotated[AbsolutePathBuf, Field(alias="dotForestxFolder")]
...
class ChatgptAuthTokensLoginAccountParams(BaseModel):
    ...
    chatgpt_plan_type: Annotated[
        ...
        Field(
            ...
            description="Optional plan type supplied by the client.\n\nWhen `null`, Forestx attempts to derive the plan type from access-token claims. If unavailable, the plan defaults to `unknown`.",
        ),
    ] = None
    type: Annotated[
...
class RateLimitResetType(Enum):
    forestx_rate_limits = "forestxRateLimits"
    unknown = "unknown"
...
class ThreadApproveGuardianDeniedActionParams(BaseModel):
    ...
    event: Annotated[
        Any, Field(description="Serialized `forestx_protocol::protocol::GuardianAssessmentEvent`.")
    ]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class ActiveTurnNotSteerableForestxErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ForestxErrorInfo(
    RootModel[
        ForestxErrorInfoValue
        | HttpConnectionFailedForestxErrorInfo
        | ResponseStreamConnectionFailedForestxErrorInfo
        | ResponseStreamDisconnectedForestxErrorInfo
        | ResponseTooManyFailedAttemptsForestxErrorInfo
        | ActiveTurnNotSteerableForestxErrorInfo
    ]
):
    model_config = ConfigDict(
        populate_by_name=True,
...
class ChatgptLoginAccountParams(BaseModel):
    ...
    forestx_streamlined_login: Annotated[bool | None, Field(alias="forestxStreamlinedLogin")] = None
...
class TurnError(BaseModel):
    ...
    forestx_error_info: Annotated[ForestxErrorInfo | None, Field(alias="forestxErrorInfo")] = None
    message: str
...
class GetAccountRateLimitsResponse(BaseModel):
    ...
    rate_limits_by_limit_id: Annotated[
        ...
        Field(
            ...
            description="Multi-bucket view keyed by metered `limit_id` (for example, `forestx`).",
        ),
    ] = None
...
class Turn(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this turn. Forestx-generated turn IDs are UUIDv7.")
    ]
    items: Annotated[
...
class Thread(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this thread. Forestx-generated thread IDs are UUIDv7.")
    ]
    ...
    source: Annotated[
        SessionSource,
        Field(
            description="Origin of the thread (CLI, VSCode, forestx exec, forestx app-server, etc.)."
        ),
    ]
