...
def ensure_local_sdk_src() -> Path:
    ...
    package_dir = src_dir / "openai_forestx"
...
def runtime_config():
    """Return an example-friendly ForestxConfig for repo-source SDK usage."""
...
def temporary_sample_image_path() -> Iterator[Path]:
    with tempfile.TemporaryDirectory(prefix="forestx-python-example-image-") as temp_root:
