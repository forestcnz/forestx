...
RUN_REAL_FORESTX_TESTS = os.environ.get("RUN_REAL_FORESTX_TESTS") == "1"
pytestmark = pytest.mark.skipif(
    not RUN_REAL_FORESTX_TESTS,
    reason="set RUN_REAL_FORESTX_TESTS=1 to run real Forestx integration coverage",
)
...
def runtime_env(tmp_path_factory: pytest.TempPathFactory) -> PreparedRuntimeEnv:
    ...
    env["FORESTX_PYTHON_SDK_DIR"] = str(ROOT)
