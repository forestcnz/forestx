...
GENERATED_TARGETS = [
    Path("src/openai_forestx/generated/notification_registry.py"),
    Path("src/openai_forestx/generated/v2_all.py"),
    Path("src/openai_forestx/api.py"),
]
...
def test_generated_files_are_up_to_date():
    ...
    assert importlib.metadata.version("openai-forestx-cli-bin") == "0.144.4"
    env = os.environ.copy()
    env.pop("FORESTX_EXEC_PATH", None)
