...
from openai_forestx import ForestxConfig
...
class AppServerHarness:
    ...
    def __init__(self, tmp_path: Path, *, requires_openai_auth: bool = False) -> None:
        ...
        self.forestx_home = tmp_path / "forestx-home"
    ...
    def __exit__(self, _exc_type: object, _exc: object, _tb: object) -> None:
        ...
        shutil.rmtree(self.forestx_home, ignore_errors=True)
        shutil.rmtree(self.workspace, ignore_errors=True)

    def app_server_config(self) -> ForestxConfig:
        """Build SDK config for an isolated pinned-runtime app-server process."""
        return ForestxConfig(
            cwd=str(self.workspace),
            env={
                "FORESTX_HOME": str(self.forestx_home),
                "FORESTX_APP_SERVER_DISABLE_MANAGED_CONFIG": "1",
                "RUST_LOG": "warn",
            },
        )
    ...
    def _write_config(self) -> None:
        ...
        config_toml = self.forestx_home / "config.toml"
