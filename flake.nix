{
  description = "Development Nix flake for OpenAI Forestx CLI";
  ...
  outputs = { self, nixpkgs, rust-overlay, ... }:
    let
      ...
      cargoToml = builtins.fromTOML (builtins.readFile ./forestx-rs/Cargo.toml);
    ...
    in
    {
      packages = forAllSystems (system:
        let
          ...
          forestx-rs = pkgs.callPackage ./forestx-rs {
            inherit version;
